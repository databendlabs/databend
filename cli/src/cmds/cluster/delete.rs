...
impl DeleteCommand {
    ...
    pub fn generate() -> App<'static> {
        App::new("create")
            ...
            .arg(Arg::new("profile").long("profile").about("Profile to delete, support local and cluster").required(false).possible_values(&["local"]))
            .arg(Arg::new("purge").long("purge").about("Purge would "))
    }
