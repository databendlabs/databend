...
```sql
SELECT toDate(18875), subtractYears(toDate(18875), 2);
+---------------+---------------------------------+
...
SELECT toDate(18875), subtractMonths(toDate(18875), 2);
+---------------+----------------------------------+
...
SELECT toDate(18875), subtractDays(toDate(18875), 2);
+---------------+--------------------------------+
...
SELECT toDateTime(1630833797), subtractHours(toDateTime(1630833797), 2);
+------------------------+------------------------------------------+
...
SELECT toDateTime(1630833797), subtractMinutes(toDateTime(1630833797), 2);
+------------------------+--------------------------------------------+
...
SELECT toDateTime(1630833797), subtractSeconds(toDateTime(1630833797), 2);
+------------------------+--------------------------------------------+
