...
In this tutorial, you will upload a sample file to your Amazon S3 bucket, and then load data from the file into Databend with the [COPY INTO](../30-reference/30-sql/10-dml/dml-copy-into-table.md) command.
