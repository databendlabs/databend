...
The command can also load data from multiple files that are sequentially named. See [COPY INTO `<table>`](https://databend.rs/doc/sql-commands/dml/dml-copy-into-table) for details.
