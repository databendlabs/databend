...
1. Load data into the target table with the [COPY INTO](https://databend.rs/doc/sql-commands/dml/dml-copy-into-table) command:
...
1. Create an internal stage with the [CREATE STAGE](https://databend.rs/doc/sql-commands/ddl/stage/ddl-create-stage) command:
...
1. Create an external stage with the [CREATE STAGE](https://databend.rs/doc/sql-commands/ddl/stage/ddl-create-stage) command:
