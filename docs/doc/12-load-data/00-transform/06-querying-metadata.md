...
The syntax for INFER_SCHEMA is as follows. For more detailed information about this function, see [INFER_SCHEMA](https://databend.rs/doc/sql-functions/table-functions/infer_schema).
