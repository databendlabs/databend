...
* [How to Connect Databend With MySQL Client](../30-reference/00-api/01-mysql-handler.md)
* [How to Connect Databend With ClickHouse Client](../30-reference/00-api/02-clickhouse-handler.md)
* [How to Connect Databend With REST API](../30-reference/00-api/00-rest.md)
* [How to Connect Databend With DBeaver SQL IDE](../40-integrations/20-gui-tool/01-dbeaver.md)
* [How to Execute Queries in Python](../20-develop/01-python.md)
* [How to Query Databend in Jupyter Notebooks](../40-integrations/20-gui-tool/00-jupyter.md)
...
* [How to Create a User](../30-reference/30-sql/00-ddl/30-user/01-user-create-user.md)
* [How to Grant Privileges to a User](../30-reference/30-sql/00-ddl/30-user/10-grant-privileges.md)
* [How to Revoke Privileges From a User](../30-reference/30-sql/00-ddl/30-user/11-revoke-privileges.md)
* [How to Create a Role](../30-reference/30-sql/00-ddl/30-user/04-user-create-role.md)
* [How to Grant Privileges to a Role](../30-reference/30-sql/00-ddl/30-user/10-grant-privileges.md)
...
* [How to Analyze User Retention With Databend](../90-learn/03-analyze-user-retention-with-databend.md)
* [How to Do Funnel Analysis With Databend](../90-learn/04-analyze-funnel-with-databend.md)
...
* [How to Benchmark Databend](../90-learn/01-analyze-ontime-with-databend-on-ec2-and-s3.md)
