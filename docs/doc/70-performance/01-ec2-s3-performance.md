...
* [Analyzing OnTime Datasets with Databend on AWS EC2 and S3](../21-use-cases/01-analyze-ontime-with-databend-on-ec2-and-s3.md)
:::
...
Read 61000000 rows, 183 MB in 0.150 sec., 407.86 million rows/sec., 1.22 GB/sec.
```
...
## Q2 (0.349 sec., 174.92 million rows/sec., 1.22 GB/sec.)
...
Read 61000000 rows, 427 MB in 0.349 sec., 174.92 million rows/sec., 1.22 GB/sec.
```
...
## Q3 (0.368 sec., 165.96 million rows/sec., 2.82 GB/sec.)
...
Read 61000000 rows, 1.04 GB in 0.368 sec., 165.96 million rows/sec., 2.82 GB/sec.
```
...
## Q4 (0.126 sec., 63.48 million rows/sec., 1.02 GB/sec.)
...
Read 8000000 rows, 128 MB in 0.126 sec., 63.48 million rows/sec., 1.02 GB/sec.
```
...
## Q5 (0.151 sec., 52.81 million rows/sec., 844.98 MB/sec)
...
Read 8000000 rows, 128 MB in 0.151 sec., 52.81 million rows/sec., 844.98 MB/sec.
```
...
## Q6 (0.337 sec., 180.83 million rows/sec., 2.89 GB/sec.)
...
+---------+--------------------+
25 rows in set (0.44 sec)
Read 61000000 rows, 976 MB in 0.337 sec., 180.83 million rows/sec., 2.89 GB/sec.
```
...
## Q7 (0.331 sec., 184.12 million rows/sec., 2.95 GB/sec.)
...
Read 61000000 rows, 976 MB in 0.331 sec., 184.12 million rows/sec., 2.95 GB/sec.
```
...
## Q8 (0.799 sec., 253.64 million rows/sec., 1.52 GB/sec.)
...
+------+--------------------+
35 rows in set (0.92 sec)
Read 202687655 rows, 1.22 GB in 0.799 sec., 253.64 million rows/sec., 1.52 GB/sec.
```
...
## Q9 (0.330 sec., 613.82 million rows/sec., 1.23 GB/sec.)
```sql
SELECT
    Year,
    count(*) AS c1
...
| 1998 | 5384721 |
+------+---------+
35 rows in set (0.48 sec)
Read 202687655 rows, 405.38 MB in 0.330 sec., 613.82 million rows/sec., 1.23 GB/sec.
```
...
## Q10 (0.592 sec., 342.12 million rows/sec., 2.39 GB/sec.)
...
Read 202687655 rows, 1.42 GB in 0.592 sec., 342.12 million rows/sec., 2.39 GB/sec.
```
...
## Q11 (0.426 sec., 475.6 million rows/sec., 1.43 GB/sec.)
...
Read 202687655 rows, 608.06 MB in 0.426 sec., 475.6 million rows/sec., 1.43 GB/sec.
```
...
## Q12 (2.704 sec., 74.95 million rows/sec., 3.17 GB/sec.)
...
Read 202687655 rows, 8.58 GB in 2.704 sec., 74.95 million rows/sec., 3.17 GB/sec.
```
...
## Q13 (1.110 sec., 182.62 million rows/sec., 3.86 GB/sec.)
...
Read 202687655 rows, 4.29 GB in 1.110 sec., 182.62 million rows/sec., 3.86 GB/sec.
```
