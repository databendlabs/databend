...
#[derive(Clone)]
pub struct MetaStoreClient<T = StoreClient>
...
impl<T> MetaStoreClient<T>
where T: 'static + StoreApis + Clone
{
    pub fn create(apis_provider: StoreApisProvider<T>) -> MetaStoreClient<T> {
...
impl RemoteMetaBackend for MetaStoreClient {
    fn get_table_by_id(
        &self,
        db_name: &str,
        table_id: MetaId,
