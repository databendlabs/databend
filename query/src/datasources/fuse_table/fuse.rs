...
<<<<<<< HEAD:query/src/datasources/table/fuse/table.rs
...
=======
use crate::datasources::fuse_table::io::block_appender::BlockAppender;
...
>>>>>>> block_appender:query/src/datasources/fuse_table/fuse.rs
...
impl Table for FuseTable {
    ...
    async fn append_data(
        ...
        let appender = BlockAppender::new(self.data_accessor(&ctx)?);
...
=======
        ...
        Ok((snapshot_id, new_snapshot_id))
