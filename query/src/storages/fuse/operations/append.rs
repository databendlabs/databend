...
use crate::storages::fuse::TBL_OPT_BLOCK_PER_SEGMENT;
use crate::storages::fuse::TBL_OPT_ROW_PER_BLOCK;
...
impl FuseTable {
    ...
    pub async fn append_trunks(
        ...
        let rows_per_block = self.get_option(TBL_OPT_ROW_PER_BLOCK, DEFAULT_ROW_PER_BLOCK);

        let block_per_seg = self.get_option(TBL_OPT_BLOCK_PER_SEGMENT, DEFAULT_BLOCK_PER_SEGMENT);
