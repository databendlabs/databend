...
use common_datablocks::{DataBlock, HashMethodKeysU32, HashMethodFixedKeys};
use common_datablocks::HashMethod;
use common_datablocks::HashMethodKind;
use common_datavalues::arrays::BinaryArrayBuilder;
use common_datavalues::prelude::*;
use common_exception::Result;
use common_functions::aggregates::{get_layout_offsets, AggregateFunctionRef};
...
use crate::common::{HashTable, DefaultHashTableEntity, HashTableEntity};
        ...
        match method {
            ...
            HashMethodKind::KeysU32(hash_method) => {
                ...
                let groups_locker = aggregate(
                    ...
                    aggr_funcs_len, group_cols, stream, arena, layout,
                    offsets_aggregate_states.clone(), hash_method,
                ).await?;
...
) -> Result<RwLock<HashTable<u32, DefaultHashTableEntity<u32, usize>, crate::common::DefaultHasher<u32>>>> {
    type GroupFuncTable = HashTable<u32, DefaultHashTableEntity<u32, usize>, crate::common::DefaultHasher<u32>>;
    let groups_locker = RwLock::new(GroupFuncTable::new());
