...
/// call system$create_warehouse_meta("tenant1", "warehouse*!)#@!!#@!", "Small", "10")
/// ```
...
/// call system$get_warehouse_meta("tenant1", "warehouse*!)#@!!#@!")
/// ```
...
/// call system$list_warehouse_meta("tenant1")
/// ```
...
/// call system$drop_warehouse_meta("tenant1", "warehouse*!)#@!!#@!")
/// ```
