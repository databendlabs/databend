...
async fn test_memorytable() -> Result<()> {
    ...
    // read tests
    {
        ...
        let expected_statistics_vec = vec![
            Statistics::new_estimated(4usize, 16usize, 1usize, 1usize),
            Statistics::new_estimated(4usize, 32usize, 1usize, 1usize),
            Statistics::new_exact(4usize, 48usize, 1usize, 1usize),
        ];
