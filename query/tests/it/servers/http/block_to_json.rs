...
fn test_data_block(is_nullable: bool) -> Result<()> {
    let schema = if is_nullable {
        DataSchemaRefExt::create(vec![
            DataField::new("c1", DataType::Int32.enforce_nullable(), is_nullable),
            DataField::new("c2", DataType::String.enforce_nullable(), is_nullable),
            DataField::new("c3", DataType::Boolean.enforce_nullable(), is_nullable),
            DataField::new("c4", DataType::Float64.enforce_nullable(), is_nullable),
            DataField::new("c5", DataType::Date16.enforce_nullable(), is_nullable),
        ])
    } else {
        DataSchemaRefExt::create(vec![
