...
async fn test_skip_read_data_source() -> Result<()> {
    ...
    let tests: Vec<Test> = vec![
            ...
            Test {
                ...
                expect: "\
                Limit: 0\
                \n  Projection: number:UInt64\n    Filter: true\n      ReadDataSource: scan schema: [number:UInt64], statistics: [read_rows: 0, read_bytes: 0, partitions_scanned: 0, partitions_total: 0], push_downs: [projections: [0], filters: [true], limit: 0, order_by: []]",
            },
            Test {
