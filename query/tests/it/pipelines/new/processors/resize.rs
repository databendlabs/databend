...
use databend_query::pipelines::new::processors::processor::Event;
use databend_query::pipelines::new::processors::Processor;
use databend_query::pipelines::new::processors::ResizeProcessor;
