...
async fn test_interpreter_interceptor() -> Result<()> {
    ...
    // Check.
    {
        ...
        let expected = vec![
            ...
            "+----------+--------------+-----------+--------------+-----------+------------+--------------+---------------+-------------+--------------+------------+------------------------------------------------------+-----------+-----------------------------+---------------------------------------------------------------------------+",
            "| 1        | TestSession  | 8         | 3461         | 0         | 0          | 0            | 0             | 0           | 0            | SelectPlan | select number from numbers_mt(100) where number > 90 | test_user | UserGrantSet { grants: [] } | UserQuota { max_cpu: 0, max_memory_in_bytes: 0, max_storage_in_bytes: 0 } |",
            "| 2        | TestSession  | 8         | 3461         | 100       | 800        | 0            | 0             | 9           | 72           | SelectPlan | select number from numbers_mt(100) where number > 90 | test_user | UserGrantSet { grants: [] } | UserQuota { max_cpu: 0, max_memory_in_bytes: 0, max_storage_in_bytes: 0 } |",
            "+----------+--------------+-----------+--------------+-----------+------------+--------------+---------------+-------------+--------------+------------+------------------------------------------------------+-----------+-----------------------------+---------------------------------------------------------------------------+",
        ];
