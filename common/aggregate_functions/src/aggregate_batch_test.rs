    ...
    let tests = vec![
        ArrayTest {
            ...
            args: vec![
                ...
                Series::new(vec![1 as i8, 2, 3, 4]).into(),
                Series::new(vec![4 as i16, 3, 2, 1]).into(),
                Series::new(vec![4 as i32, 3, 2, 1]).into(),
                Series::new(vec![4 as i64, 3, 2, 1]).into(),
                Series::new(vec![4 as u8, 3, 2, 1]).into(),
                Series::new(vec![4 as u16, 3, 2, 1]).into(),
                Series::new(vec![4 as u32, 3, 2, 1]).into(),
                Series::new(vec![4 as u64, 3, 2, 1]).into(),
                Series::new(vec![4.0 as f32, 3.0, 2.0, 1.0]).into(),
                Series::new(vec![4.0 as f64, 3.0, 2.0, 1.0]).into(),
            ],
        ...
        ArrayTest {
            ...
            args: vec![
                ...
                Series::new(vec![1 as i8, 2, 3, 4]),
                Series::new(vec![4 as i16, 3, 2, 1]),
                Series::new(vec![4 as i32, 3, 2, 1]),
                Series::new(vec![4 as i64, 3, 2, 1]),
                Series::new(vec![4 as u8, 3, 2, 1]),
                Series::new(vec![4 as u16, 3, 2, 1]),
                Series::new(vec![4 as u32, 3, 2, 1]),
                Series::new(vec![4 as u64, 3, 2, 1]),
                Series::new(vec![4.0 as f32, 3.0, 2.0, 1.0]),
                Series::new(vec![4.0 as f64, 3.0, 2.0, 1.0]),
            ],
