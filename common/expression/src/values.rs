...
impl ColumnBuilder {
    ...
    pub fn with_capacity(ty: &DataType, capacity: usize) -> ColumnBuilder {
        match ty {
            ...
            DataType::Date => ColumnBuilder::Int32(Vec::with_capacity(capacity)),
            DataType::Interval => ColumnBuilder::Int64(Vec::with_capacity(capacity)),
            DataType::Timestamp => ColumnBuilder::Int64(Vec::with_capacity(capacity)),
