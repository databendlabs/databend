...
#[derive(Debug)]
pub struct ArrowBooleanArrayBuilder {
    values_builder: BooleanBufferBuilder,
    bitmap_builder: BooleanBufferBuilder,
}

impl ArrowBooleanArrayBuilder {
...
impl ArrayBuilder for ArrowBooleanArrayBuilder {
...
/// as buffer
pub struct ArrowPrimitiveArrayBuilder<T>
where
...
impl<T> ArrowPrimitiveArrayBuilder<T>
where
    T: ArrowPrimitiveType,
    T::Native: Default,
{
...
impl<T> ArrayBuilder for ArrowPrimitiveArrayBuilder<T>
where T: ArrowPrimitiveType
{
    ...
    fn finish(&mut self) -> ArrayRef {
        Arc::new(ArrowPrimitiveArrayBuilder::finish(self))
    }
