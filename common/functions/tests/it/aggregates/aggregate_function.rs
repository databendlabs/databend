...
fn test_aggregate_function() -> Result<()> {
    ...
    let args = vec![
        ...
        DataField::new("b", DataType::Int64(false), false),
        // args for window funnel function
        DataField::new("dt", DataType::DateTime32(false, None), false),
...
fn test_aggregate_function_on_empty_data() -> Result<()> {
    ...
    let args = vec![
        ...
        DataField::new("b", DataType::Int64(true), true),
    ];
...
fn test_covariance_with_comparable_data_sets() -> Result<()> {
    ...
    let args = vec![
        DataField::new("a", DataType::Float32(false), false),
        DataField::new("b", DataType::Int16(false), false),
    ];
