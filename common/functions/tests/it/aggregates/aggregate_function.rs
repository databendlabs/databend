...
fn test_aggregate_function() -> Result<()> {
    ...
    let args = vec![
        ...
        DataField::new("dt", TimestampType::new_impl(0)),
        ...
        DataField::new("str", Vu8::to_data_type()),
    ];
    ...
    let tests = vec![
        ...
        Test {
            ...
            display: "window_funnel",
            func_name: "window_funnel",
            arrays: vec![
                arrays[2].clone(),
                arrays[3].clone(),
                arrays[4].clone(),
    ...
    for mut t in tests {
        ...
        let mut func = || -> Result<()> {
            ...
            assert_eq!(res_col, t.expect_array);
