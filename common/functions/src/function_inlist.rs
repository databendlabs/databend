...
impl Function for InListFunction {
    ...
    fn eval(&self, columns: &[DataColumn], _input_rows: usize) -> Result<DataColumn> {
        ...
        match &self.value_data_type {
            DataType::Float32 => {
                make_contains!(array, self.list, self.negated, Float32, Float32Array)
            }
            DataType::Float64 => {
                make_contains!(array, self.list, self.negated, Float64, Float64Array)
            }
            DataType::Int16 => {
                make_contains!(array, self.list, self.negated, Int16, Int16Array)
            }
            DataType::Int32 => {
                make_contains!(array, self.list, self.negated, Int32, Int32Array)
            }
            DataType::Int64 => {
                make_contains!(array, self.list, self.negated, Int64, Int64Array)
            }
            DataType::Int8 => {
                make_contains!(array, self.list, self.negated, Int8, Int8Array)
            }
            DataType::UInt16 => {
                make_contains!(array, self.list, self.negated, UInt16, UInt16Array)
            }
            DataType::UInt32 => {
                make_contains!(array, self.list, self.negated, UInt32, UInt32Array)
            }
            DataType::UInt64 => {
                make_contains!(array, self.list, self.negated, UInt64, UInt64Array)
            }
            DataType::UInt8 => {
                make_contains!(array, self.list, self.negated, UInt8, UInt8Array)
            }
            DataType::Boolean => {
                make_contains!(array, self.list, self.negated, Boolean, BooleanArray)
            }
