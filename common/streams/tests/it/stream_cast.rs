...
async fn test_cast_stream() {
    ...
    let to_uint8 = Function2Adapter::create(CastFunction::create("cast", "UInt8").unwrap());
    let to_uint16 = Function2Adapter::create(CastFunction::create("cast", "UInt16").unwrap());
