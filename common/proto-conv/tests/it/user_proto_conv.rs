...
fn test_load_old_user() -> anyhow::Result<()> {
    ...
    // UserStage is loadable
    {
        let user_stage_info_v1: Vec<u8> = vec![
            ...
            97, 47, 102, 105, 108, 101, 115, 16, 1, 26, 94, 10, 92, 10, 90, 18, 24, 104, 116, 116,
            ...
            97, 115, 116, 101, 114, 95, 107, 101, 121, 34, 17, 8, 1, 16, 128, 8, 26, 1, 124, 34, 2,
            47, 47, 40, 2, 160, 6, 1, 42, 8, 10, 3, 32, 154, 5, 16, 142, 8, 50, 4, 116, 101, 115,
            116, 160, 6, 1,
        ];
