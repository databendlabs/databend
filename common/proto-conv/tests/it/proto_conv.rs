...
fn test_load_old() -> anyhow::Result<()> {
    ...
    // TableInfo is loadable
    {
        let tbl_info_v1: Vec<u8> = vec![
            10, 7, 8, 5, 16, 6, 160, 6, 1, 18, 3, 102, 111, 111, 26, 3, 98, 97, 114, 34, 155, 4,
            10, 176, 3, 10, 36, 10, 8, 110, 117, 108, 108, 97, 98, 108, 101, 18, 4, 97, 61, 61, 98,
            ...
            160, 6, 1, 160, 6, 1, 160, 6, 1, 18, 6, 10, 1, 97, 18, 1, 98, 160, 6, 1, 42, 10, 10, 3,
            120, 121, 122, 18, 3, 102, 111, 111, 50, 2, 52, 52, 58, 10, 10, 3, 97, 98, 99, 18, 3,
            100, 101, 102, 74, 3, 97, 62, 50, 162, 1, 23, 50, 48, 49, 52, 45, 49, 49, 45, 50, 56,
            32, 49, 50, 58, 48, 48, 58, 48, 57, 32, 85, 84, 67, 170, 1, 23, 50, 48, 49, 52, 45, 49,
            49, 45, 50, 57, 32, 49, 50, 58, 48, 48, 58, 49, 48, 32, 85, 84, 67, 178, 1, 13, 116,
            97, 98, 108, 101, 95, 99, 111, 109, 109, 101, 110, 116, 160, 6, 1, 160, 6, 1,
        ];
        let p: pb::TableInfo =
