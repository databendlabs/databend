...
async fn test_transform_partial_groupby() -> anyhow::Result<()> {
    ...
    let expected = vec![
        ...
        "+--------------------------------------------+------------------------------------------------------------+-----------------------------------------+------------------+",
        "| {\"Struct\":[{\"UInt64\":166167},{\"UInt8\":2}]} | {\"Struct\":[{\"Struct\":[{\"UInt64\":166167},{\"UInt64\":333}]}]} | {\"Struct\":[{\"UInt64\":877},{\"UInt8\":3}]} | 0100000000000000 |",
        "| {\"Struct\":[{\"UInt64\":166500},{\"UInt8\":2}]} | {\"Struct\":[{\"Struct\":[{\"UInt64\":166500},{\"UInt64\":333}]}]} | {\"Struct\":[{\"UInt64\":875},{\"UInt8\":3}]} | 0200000000000000 |",
        "| {\"Struct\":[{\"UInt64\":166833},{\"UInt8\":2}]} | {\"Struct\":[{\"Struct\":[{\"UInt64\":166833},{\"UInt64\":334}]}]} | {\"Struct\":[{\"UInt64\":876},{\"UInt8\":3}]} | 0000000000000000 |",
        "+--------------------------------------------+------------------------------------------------------------+-----------------------------------------+------------------+",
    ];
