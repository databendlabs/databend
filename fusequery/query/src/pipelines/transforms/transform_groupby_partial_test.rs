...
async fn test_transform_partial_groupby() -> anyhow::Result<()> {
    ...
    let aggr_exprs = vec![
        ...
        avg(col("number")),
        sum(modular(col("number"), lit(3u64))),
    ];
    ...
    let expected = vec![
        "+---------------------------------------------+------------------------------------------------------------+-----------------------------+------------------+",
        "| plus(sum(number), 2)                        | avg(number)                                                | sum(modulo(number, 3))      | _group_by_key    |",
        "+---------------------------------------------+------------------------------------------------------------+-----------------------------+------------------+",
        "| {\"Struct\":[{\"UInt64\":166167},{\"UInt64\":2}]} | {\"Struct\":[{\"Struct\":[{\"UInt64\":166167},{\"UInt64\":333}]}]} | {\"Struct\":[{\"UInt64\":333}]} | 0100000000000000 |",
        "| {\"Struct\":[{\"UInt64\":166500},{\"UInt64\":2}]} | {\"Struct\":[{\"Struct\":[{\"UInt64\":166500},{\"UInt64\":333}]}]} | {\"Struct\":[{\"UInt64\":666}]} | 0200000000000000 |",
        "| {\"Struct\":[{\"UInt64\":166833},{\"UInt64\":2}]} | {\"Struct\":[{\"Struct\":[{\"UInt64\":166833},{\"UInt64\":334}]}]} | {\"Struct\":[{\"UInt64\":0}]}   | 0000000000000000 |",
        "+---------------------------------------------+------------------------------------------------------------+-----------------------------+------------------+",
    ];
