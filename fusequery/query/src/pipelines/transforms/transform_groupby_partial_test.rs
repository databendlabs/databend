...
async fn test_transform_partial_groupby() -> anyhow::Result<()> {
    ...
    let expected = vec![
        ...
        "+----------------------------------------+------------------------------------------------------+---------------------------------------+---------------+",
        "| {\"Struct\":[{\"UInt64\":12},{\"UInt8\":2}]} | {\"Struct\":[{\"Struct\":[{\"UInt64\":12},{\"UInt64\":3}]}]} | {\"Struct\":[{\"UInt64\":7},{\"UInt8\":3}]} | 01            |",
        "| {\"Struct\":[{\"UInt64\":15},{\"UInt8\":2}]} | {\"Struct\":[{\"Struct\":[{\"UInt64\":15},{\"UInt64\":3}]}]} | {\"Struct\":[{\"UInt64\":8},{\"UInt8\":3}]} | 02            |",
        "| {\"Struct\":[{\"UInt64\":18},{\"UInt8\":2}]} | {\"Struct\":[{\"Struct\":[{\"UInt64\":18},{\"UInt64\":4}]}]} | {\"Struct\":[{\"UInt64\":9},{\"UInt8\":3}]} | 00            |",
        "+----------------------------------------+------------------------------------------------------+---------------------------------------+---------------+",
    ];
