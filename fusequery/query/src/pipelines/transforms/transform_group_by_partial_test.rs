...
async fn test_transform_partial_group_by() -> Result<()> {
    ...
    let expected = vec![
        ...
        "+--------------------+----------------------------------+--------+---------------+",
        "| 010000000000000000 | 00000000000000000100000000000000 | 0      | 0             |",
        "| 010100000000000000 | 01000000000000000100000000000000 | 1      | 1             |",
        "| 010200000000000000 | 02000000000000000100000000000000 | 2      | 2             |",
        "| 010300000000000000 | 03000000000000000100000000000000 | 3      | 3             |",
        "| 010400000000000000 | 04000000000000000100000000000000 | 4      | 4             |",
        "+--------------------+----------------------------------+--------+---------------+",
    ];
