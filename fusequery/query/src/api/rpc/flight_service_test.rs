...
use crate::api::rpc::{FuseQueryFlightDispatcher, FuseQueryFlightService};
use crate::tests::try_create_sessions;
use crate::api::rpc::flight_actions::FlightAction;
use crate::api::{ShuffleAction, FlightTicket};
...
async fn test_do_shuffle_action() -> Result<()> {
    ...
    service.do_action(Request::new(shuffle_action.try_into()?)).await?;
    ...
    service.do_get(Request::new(stream_ticket.try_into()?)).await?;
