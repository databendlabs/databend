...
async fn test_export() -> anyhow::Result<()> {
    ...
    async {
        ...
        let want = vec![
            ...
            r#"["test-29000-raft_log",{"Logs":{"key":2,"value":{"log_id":{"term":1,"index":2},"payload":{"Normal":{"txid":null,"cmd":{"AddNode":{"node_id":0,"node":{"name":"","endpoint":{"addr":"localhost","port":29000}}}}}}}}}]"#, //
            ...
            r#"["test-29000-state_machine/0",{"Nodes":{"key":0,"value":{"name":"","endpoint":{"addr":"localhost","port":29000}}}}]"#, //
