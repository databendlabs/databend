...
echo "CREATE TABLE t20_0016_table1(c int not null)" | $BENDSQL_CLIENT_CONNECT
...
echo "SHOW TABLES;" | $TEST_USER_CONNECT
echo "SHOW DATABASES;" | $TEST_USER_CONNECT
echo "SHOW USERS;" | $TEST_USER_CONNECT
echo "SHOW ROLES;" | $TEST_USER_CONNECT
echo "SHOW STAGES;" | $TEST_USER_CONNECT
echo "SHOW PROCESSLIST;" | $TEST_USER_CONNECT