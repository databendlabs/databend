...
## Setup
echo "create table t20_0011(c int not null)" | $MYSQL_CLIENT_CONNECT
...
TIMEPOINT=$(echo "select timestamp from fuse_snapshot('default', 't20_0011') where row_count=4" | $MYSQL_CLIENT_CONNECT)
