...
SELECT '=== series, const ===';
SELECT SUBSTRING(number * 100 + number, 2) FROM numbers(7) ORDER BY number;
SELECT '=== series, const, const ===';
SELECT SUBSTRING(number * 100 + number, 1, 1) FROM numbers(7) ORDER BY number;
SELECT '=== series, const, series ===';
SELECT SUBSTRING(number * 100 + number, 1, number) FROM numbers(7) ORDER BY number;

SELECT '=== series, series ===';
SELECT SUBSTRING(number * 100 + number, number) FROM numbers(7) ORDER BY number;
SELECT '=== series, series, const ===';
SELECT SUBSTRING(number * 100 + number, number, 1) FROM numbers(7) ORDER BY number;
SELECT '=== series, series, series ===';
SELECT SUBSTRING(number * 100 + number, number, number) FROM numbers(7) ORDER BY number;
