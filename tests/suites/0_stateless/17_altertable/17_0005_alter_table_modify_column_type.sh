...
echo "alter table test_modify_column_type.a modify column data type a float, b String"  | $MYSQL_CLIENT_CONNECT
...
echo "alter table test_modify_column_type.b modify column data type a float"  | $MYSQL_CLIENT_CONNECT
echo "alter table test_modify_column_type.b modify column data type b float"  | $MYSQL_CLIENT_CONNECT
