...
echo "alter table test_modify_column_type.a modify column a float not null, column b String not null"  | $MYSQL_CLIENT_CONNECT
...
echo "alter table test_modify_column_type.b modify column a float not null"  | $MYSQL_CLIENT_CONNECT
echo "alter table test_modify_column_type.b modify column b float not null"  | $MYSQL_CLIENT_CONNECT
...
echo "alter table test_modify_column_type.c modify column a float not null default 'a'"  | $MYSQL_CLIENT_CONNECT
echo "alter table test_modify_column_type.c modify column a float not null default 1.2"  | $MYSQL_CLIENT_CONNECT
echo "SELECT a,b from test_modify_column_type.c"  | $MYSQL_CLIENT_CONNECT
...
echo "alter table test_modify_column_type.d modify column b int not null default 2"  | $MYSQL_CLIENT_CONNECT
echo "SELECT a,b from test_modify_column_type.d"  | $MYSQL_CLIENT_CONNECT
echo "alter table test_modify_column_type.d add column c float not null default 1.01" | $MYSQL_CLIENT_CONNECT
echo "SELECT a,b,c from test_modify_column_type.d"  | $MYSQL_CLIENT_CONNECT
echo "alter table test_modify_column_type.d modify column c float not null default 2.2"  | $MYSQL_CLIENT_CONNECT
...
echo "alter table test_modify_column_type.e modify column a VARCHAR(10) not null DEFAULT 'not'"  | $MYSQL_CLIENT_CONNECT
