...
SELECT LEFT(number * 10000, 1) FROM numbers(5) ORDER BY number;

SELECT '=== LEFT series, series ===';
SELECT LEFT(number * 10000, number) FROM numbers(5) ORDER BY number;
...
SELECT RIGHT(number * 10000, 1) FROM numbers(5) ORDER BY number;

SELECT '=== RIGHT series, series ===';
SELECT RIGHT(number * 10000, number) FROM numbers(5) ORDER BY number;
