...
SELECT LPAD(number, 3, 'a') FROM numbers(5) ORDER BY number;
SELECT '=== LPAD const, series, const ===';
SELECT LPAD('1', number, 'a') FROM numbers(5) ORDER BY number;
SELECT '=== LPAD series, series, const ===';
SELECT LPAD(number, number, 'a') FROM numbers(5) ORDER BY number;
SELECT '=== LPAD const, const, series ===';
SELECT LPAD('1', 3, number) FROM numbers(5) ORDER BY number;
SELECT '=== LPAD series, const, series ===';
SELECT LPAD(number, 3, number) FROM numbers(5) ORDER BY number;
SELECT '=== LPAD const, series, series ===';
SELECT LPAD('1', number, number) FROM numbers(5) ORDER BY number;
SELECT '=== LPAD series, series, series ===';
SELECT LPAD(number, number, number) FROM numbers(5) ORDER BY number;
...
SELECT RPAD(number, 3, 'a') FROM numbers(5) ORDER BY number;
SELECT '=== RPAD const, series, const ===';
SELECT RPAD('1', number, 'a') FROM numbers(5) ORDER BY number;
SELECT '=== RPAD series, series, const ===';
SELECT RPAD(number, number, 'a') FROM numbers(5) ORDER BY number;
SELECT '=== RPAD const, const, series ===';
SELECT RPAD('1', 3, number) FROM numbers(5) ORDER BY number;
SELECT '=== RPAD series, const, series ===';
SELECT RPAD(number, 3, number) FROM numbers(5) ORDER BY number;
SELECT '=== RPAD const, series, series ===';
SELECT RPAD('1', number, number) FROM numbers(5) ORDER BY number;
SELECT '=== RPAD series, series, series ===';
SELECT RPAD(number, number, number) FROM numbers(5) ORDER BY number;
