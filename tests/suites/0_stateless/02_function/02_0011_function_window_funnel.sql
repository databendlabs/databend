...
select 1 = window_funnel(10000)(dt, event = 1000) from funnel_test;
select 2 = window_funnel(10000)(dt, event = 1000, event = 1001) from funnel_test;
select 3 = window_funnel(10000)(dt, event = 1000, event = 1001, event = 1002) from funnel_test;
select 4 = window_funnel(10000)(dt, event = 1000, event = 1001, event = 1002, event = 1008) from funnel_test;
...
select 1 = window_funnel(1)(dt, event = 1000) from funnel_test;
select 3 = window_funnel(2)(dt, event = 1003, event = 1004, event = 1005, event = 1006, event = 1007) from funnel_test;
select 4 = window_funnel(3)(dt, event = 1003, event = 1004, event = 1005, event = 1006, event = 1007) from funnel_test;
select 5 = window_funnel(4)(dt, event = 1003, event = 1004, event = 1005, event = 1006, event = 1007) from funnel_test;
