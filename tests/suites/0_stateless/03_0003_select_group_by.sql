SELECT max(number) FROM numbers_mt(0) GROUP BY number % 4 ORDER BY number % 4;
SELECT max(number) FROM numbers_mt (10) WHERE number > 99999999998 GROUP BY number % 3 ORDER BY number % 3;
