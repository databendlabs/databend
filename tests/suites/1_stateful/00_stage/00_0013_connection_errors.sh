...
stmt "create stage my_stage url= 's3://testbucket/tempdata/' connection = (connection_name='my_conn', endpoint_url='xx');"
stmt "create stage my_stage url= 'http://testbucket/tempdata/' connection = (connection_name='my_conn');"
