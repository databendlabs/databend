...
hits_statements=(
  ...
  "SELECT UserID, SearchPhrase, COUNT(*) FROM hits GROUP BY UserID, SearchPhrase ORDER BY UserID, SearchPhrase DESC LIMIT 10;"
  "SELECT '====== SQL19 ======';"
  "SELECT UserID, extract(minute FROM EventTime) AS m, SearchPhrase, COUNT(*) FROM hits GROUP BY UserID, m, SearchPhrase ORDER BY UserID, SearchPhrase DESC LIMIT 10;"
  "SELECT '====== SQL20 ======';"
