...
class TaskService(object):
    ...
    def GetTaskDependents(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/taskproto.TaskService/GetTaskDependents',
    ...
    def EnableTaskDependents(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/taskproto.TaskService/EnableTaskDependents',
