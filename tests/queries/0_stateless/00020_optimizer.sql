...
SELECT 'projection push down: push (max_threads) to readdatasource'
EXPLAIN select max_thread from system.settings where max_block_size > 10 group by default_db;
