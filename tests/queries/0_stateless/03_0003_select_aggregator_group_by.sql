...
SELECT 'SELECT min(number%3) as c1, max(number%2) as c2 FROM numbers_mt(10000) where number > 2 group by c1, c2 order by c1,c2';
SELECT min(number%3) as c1, max(number%2) as c2 FROM numbers_mt(10000) where number > 2 group by c1, c2 order by c1,c2;
