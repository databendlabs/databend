...
ChunkId(00_000_000_000_000_000_000)
  ...
  R-00006: [000_000_277, 000_000_472) Size(195): Append(log_id: T1-N1.2, payload: normal:time: <TIME> cmd: add_node(no-override):1=id=1 raft=localhost:28103 grpc=127.0.0.1:9191 raft_tls=)
  ...
  R-00011: [000_000_689, 000_000_884) Size(195): Append(log_id: T1-N1.4, payload: normal:time: <TIME> cmd: add_node(override):1=id=1 raft=localhost:28103 grpc=127.0.0.1:9191 raft_tls=)
...
ChunkId(00_000_000_000_000_000_000)
  ...
  R-00007: [000_000_323, 000_000_518) Size(195): Append(log_id: T1-N1.2, payload: normal:time: <TIME> cmd: add_node(no-override):1=id=1 raft=localhost:28103 grpc=127.0.0.1:9191 raft_tls=)
  R-00008: [000_000_518, 000_000_564) Size(46): Commit(T1-N1.2)
  R-00009: [000_000_564, 000_000_643) Size(79): Append(log_id: T1-N1.3, payload: membership:{voters:[{1:EmptyNode}], learners:[]})
  R-00010: [000_000_643, 000_000_689) Size(46): Commit(T1-N1.3)
  R-00011: [000_000_689, 000_000_884) Size(195): Append(log_id: T1-N1.4, payload: normal:time: <TIME> cmd: add_node(override):1=id=1 raft=localhost:28103 grpc=127.0.0.1:9191 raft_tls=)
...
ChunkId(00_000_000_000_000_000_000)
  ...
  R-00010: [000_000_643, 000_000_838) Size(195): Append(log_id: T1-N1.4, payload: normal:time: <TIME> cmd: add_node(override):1=id=1 raft=localhost:28103 grpc=127.0.0.1:9191 raft_tls=)
