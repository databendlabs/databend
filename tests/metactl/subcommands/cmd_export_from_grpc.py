...
["raft_log",{"LogEntry":{"log_id":{"leader_id":{"term":1,"node_id":1},"index":5},"payload":{"Normal":{"time_ms":1753508279640,"cmd":{"Transaction":{"condition":[{"key":"app/db/host","expected":2,"target":{"Seq":0}}],"if_then":[{"request":{"Put":{"key":"app/db/host","value":[108,111,99,97,108,104,111,115,116],"prev_value":true,"expire_at":null,"match_seq":null}}}],"else_then":[{"request":{"Get":{"key":"app/db/host"}}}]}}}}}}]
["raft_log",{"LogEntry":{"log_id":{"leader_id":{"term":1,"node_id":1},"index":6},"payload":{"Normal":{"time_ms":1753508279673,"cmd":{"Transaction":{"condition":[{"key":"app/db/port","expected":2,"target":{"Seq":0}}],"if_then":[{"request":{"Put":{"key":"app/db/port","value":[53,52,51,50],"prev_value":true,"expire_at":null,"match_seq":null}}}],"else_then":[{"request":{"Get":{"key":"app/db/port"}}}]}}}}}}]
["raft_log",{"LogEntry":{"log_id":{"leader_id":{"term":1,"node_id":1},"index":7},"payload":{"Normal":{"time_ms":1753508279702,"cmd":{"Transaction":{"condition":[{"key":"app/config/timeout","expected":2,"target":{"Seq":0}}],"if_then":[{"request":{"Put":{"key":"app/config/timeout","value":[51,48],"prev_value":true,"expire_at":null,"match_seq":null}}}],"else_then":[{"request":{"Get":{"key":"app/config/timeout"}}}]}}}}}}]
