...
["state_machine/0",{"GenericKV":{"key":"app/db/port","value":{"seq":2,"meta":null,"data":[53,52,51,50]}}}]'''
    ...
    assert os.path.exists(target_raft_dir), f"Raft directory should exist: {target_raft_dir}"
    ...
    assert header_data[1]["DataHeader"]["value"]["version"] == "V004", "Should import V004 data"
