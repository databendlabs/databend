...
# share client
export QUERY_MYSQL_HANDLER_SHARE_PROVIDER_PORT="13307"
export QUERY_MYSQL_HANDLER_SHARE_CONSUMER_PORT="23307"
export MYSQL_CLIENT_PROVIDER_CONNECT="mysql -uroot --host ${QUERY_MYSQL_HANDLER_HOST} --port ${QUERY_MYSQL_HANDLER_SHARE_PROVIDER_PORT} ${MYSQL_DATABASE} -s"
export MYSQL_CLIENT_CONSUMER_CONNECT="mysql -uroot --host ${QUERY_MYSQL_HANDLER_HOST} --port ${QUERY_MYSQL_HANDLER_SHARE_CONSUMER_PORT} ${MYSQL_DATABASE} -s"
