...
export SHARING_MYSQL_HANDLER_PORT=${SHARING_MYSQL_HANDLER_PORT:="53307"}
...
export SHARING_MYSQL_CLIENT_CONNECT="mysql -uroot --host ${QUERY_MYSQL_HANDLER_HOST} --port ${SHARING_MYSQL_HANDLER_PORT} ${MYSQL_DATABASE} -s"
