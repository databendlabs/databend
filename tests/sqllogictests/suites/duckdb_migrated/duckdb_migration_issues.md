...
- Generated at (UTC): 2026-03-19T08:56:40.447424+00:00
- Scan root: `tests/sqllogictests/suites/duckdb_migrated`
- Tracked issues: 245
- Files with issues: 2400
- Unknown function TODOs: 1211
- Unsupported feature TODOs: 33491
- Unknown function unique issues: 0
- Unsupported feature unique issues: 105
...
| Feature Signature | Reason | Count | Files | SQL (sample) | Refs |
| --- | --- | ---: | --- | --- | --- |
| `actors` | `unsupported feature` | 1 | sql/types/nested/list/array_agg.test | `statement ok<br>CREATE TABLE actors(actor_id INTEGER, first_name VARCHAR, last_name VARCHAR)` |  |
| `albums` | `unsupported feature` | 1 | sql/types/enum/test_enum_cast.test | `statement ok<br>CREATE TABLE albums (<br>    name text,<br>    year_release years<br>);` |  |
| `albums_error` | `unsupported feature` | 1 | sql/types/enum/test_enum_cast.test | `statement ok<br>CREATE TABLE albums_error (<br>    name text,<br>    year_release years_error<br>);` |  |
| `align_tbl` | `unsupported feature` | 1 | sql/types/map/map_const_and_col_combination.test | `statement ok<br>CREATE TABLE align_tbl (i INT[]);` |  |
| `allconst` | `unsupported feature` | 1 | sql/types/map/map_const_and_col_combination.test | `statement ok<br>CREATE TABLE allconst (i INT);` |  |
| `apply` | `unsupported feature` | 1 | sql/types/nested/array/array_misc.test | `query I<br>SELECT a.apply(lambda x: x + 1)::INTEGER[3] FROM arrays<br>----<br>[2, 3, 4]<br>[2, 3, 5]<br>[8, 9, 10]<br>[0, -1, -2]<br>NULL<br>[5, NULL, 3]` |  |
| `array_pop_back` | `unsupported feature` | 2 | sql/types/nested/list/test_list_functions_with_null_structs.test<br>sql/types/nested/list/test_list_slice.test | `query I<br>SELECT array_pop_back(str) FROM struct_data;<br>----<br>NULL` |  |
| `array_pop_front` | `unsupported feature` | 2 | sql/types/nested/list/test_list_functions_with_null_structs.test<br>sql/types/nested/list/test_list_slice.test | `query I<br>SELECT array_pop_front(str) FROM struct_data;<br>----<br>NULL` |  |
| `array_tbl` | `unsupported feature` | 1 | sql/types/nested/array/array_fuzzer_failures.test | `statement ok<br>CREATE TABLE array_tbl(c50 INTEGER[2][]);;` |  |
| `array_value` | `unsupported feature` | 32 | sql/types/nested/array/array_cast.test<br>sql/types/nested/array/array_coverage.test<br>sql/types/nested/array/array_invalid.test<br>sql/types/nested/array/array_joins.test<br>sql/types/nested/array/array_large.test<br>sql/types/nested/array/array_simple.test<br>sql/types/nested/array/array_storage_3.test<br>sql/types/nested/array/array_try_cast.test<br>sql/types/nested/array/array_tupleformat.test<br>sql/types/nested/array/array_unnest.test | `statement error<br>SELECT array_value();` |  |
| `arrays2` | `unsupported feature` | 3 | sql/types/nested/array/array_roundtrip_csv.test<br>sql/types/nested/array/array_roundtrip_json.test<br>sql/types/nested/array/array_roundtrip_parquet.test | `statement ok<br>CREATE OR REPLACE TABLE arrays2 (a INTEGER[3])` |  |
| `attimezone` | `unsupported feature` | 2 | sql/timezone/test_icu_timezone.test | `statement ok<br>CREATE TABLE attimezone (ts TIMESTAMP, tstz TIMESTAMPTZ, ttz TIMETZ, tz VARCHAR);` |  |
| `baz` | `unsupported feature` | 6 | sql/types/enum/test_enum_schema.test | `statement ok<br>CREATE TABLE foo.baz (<br>	bar_col foo.bar NOT NULL<br>);` |  |
| `bignum_comparisons` | `unsupported feature` | 1 | sql/types/bignum/test_bignum_comparisons.test | `statement ok<br>CREATE TABLE bignum_comparisons(a bignum);` |  |
| `bignum_nulls` | `unsupported feature` | 1 | sql/types/bignum/test_bignum_sum.test | `statement ok<br>CREATE TABLE bignum_nulls (a BIGNUM, b BIGNUM);` |  |
| `bignum_zero` | `unsupported feature` | 1 | sql/types/bignum/test_bignum_sum.test | `statement ok<br>CREATE TABLE bignum_zero (x BIGNUM);` |  |
| `bit` | `unsupported feature` | 1 | sql/types/bit/test_bit.test | `query I<br>SELECT ('0101011'::BIT(10))<br>----<br>0101011` |  |
| `bit_position` | `unsupported feature` | 4 | sql/types/bit/test_bit_functions.test | `query I<br>SELECT bit_position('010'::BIT, '010111'::BIT)<br>----<br>1` |  |
| `blobs2` | `unsupported feature` | 1 | sql/types/blob/test_blob_operator.test | `statement ok<br>CREATE TABLE blobs2 (b BYTEA, g INTEGER);` |  |
| `concat_ws` | `unsupported feature` | 1 | sql/types/list/list_to_varchar_cast.test | `query I<br>SELECT concat_ws('.', list_reverse(string_split('1.2..3', '.')));<br>----<br>[3, '', 2, 1]` |  |
| `current_localtime` | `unsupported feature` | 1 | sql/timezone/test_icu_timezone.test | `statement ok<br>select current_localtime();` |  |
| `current_localtimestamp` | `unsupported feature` | 1 | sql/timezone/test_icu_timezone.test | `statement ok<br>select current_localtimestamp();` |  |
| `date` | `unsupported feature` | 1 | sql/types/date/test_date.test | `query III<br>SELECT '2021-03-01'::DATE, DATE '2021-03-01', DATE('2021-03-01')<br>----<br>2021-03-01<br>2021-03-01<br>2021-03-01` |  |
| `dates_table` | `unsupported feature` | 1 | sql/types/enum/test_enum_cast.test | `statement ok<br>CREATE TABLE dates_table (<br>    year_release dates<br>);` |  |
| `dec` | `unsupported feature` | 1 | sql/types/decimal/test_empty_dec.test | `query II<br>SELECT 1.25::FLOAT::DEC, 1.25::FLOAT::DEC()<br>----<br>1.250	1.250` |  |
| `decimals2` | `unsupported feature` | 1 | sql/types/decimal/test_decimal_2411.test | `statement ok<br>CREATE TABLE decimals2(i DECIMAL(38,1))` |  |
| `decs` | `unsupported feature` | 1 | sql/types/decimal/test_empty_dec.test | `statement ok<br>CREATE TABLE decs(i DEC(), j DEC)` |  |
| `doubles_table` | `unsupported feature` | 1 | sql/types/nested/array/array_unnest.test | `statement ok<br>CREATE TABLE doubles_table (doubles_dynamic DOUBLE[], doubles_fixed DOUBLE[2]);` |  |
| `duckdata` | `unsupported feature` | 1 | sql/types/nested/list/test_list_slice.test | `statement ok<br>CREATE TABLE duckdata(c0 char(1), c1 char(1), c2 char(1));` |  |
| `duckdb_schemas` | `unsupported feature` | 2 | sql/transactions/test_create_drop_conflict_variation1.test<br>sql/transactions/test_create_drop_conflict_variation2.test | `query I<br>select schema_name from duckdb_schemas() where schema_name = 'foo';<br>----` |  |
| `err` | `unsupported feature` | 1 | sql/types/nested/list/test_list_slice_step.test | `statement ok<br>CREATE TABLE err(a INT[], start int, stop int, step int);` |  |
| `failing` | `unsupported feature` | 1 | sql/types/alias/test_alias_struct_nested_alias.test | `statement ok<br>CREATE TABLE failing (<br>    top_nest TOP_NEST<br>);` |  |
| `film_actor` | `unsupported feature` | 1 | sql/types/nested/list/array_agg.test | `statement ok<br>CREATE TABLE film_actor(film_id INTEGER, actor_id INTEGER)` |  |
| `films` | `unsupported feature` | 1 | sql/types/nested/list/array_agg.test | `statement ok<br>CREATE TABLE films(film_id INTEGER, title VARCHAR)` |  |
| `filter` | `unsupported feature` | 1 | sql/types/nested/array/array_misc.test | `query I<br>SELECT a.filter(lambda x: x > 0) FROM arrays<br>----<br>[1, 2, 3]<br>[1, 2, 4]<br>[7, 8, 9]<br>[]<br>NULL<br>[4, 2]` |  |
| `filter_data` | `unsupported feature` | 1 | sql/types/nested/list/test_list_functions_with_null_structs.test | `statement ok<br>CREATE TABLE filter_data(foo text[]);` |  |
| `final` | `unsupported feature` | 2 | sql/topn/tpcds_q14_topn.test<br>sql/topn/tpcds_q59_topn.test | `statement ok<br>CREATE TABLE final(channel VARCHAR, i_brand_id INTEGER, i_class_id INTEGER, i_category_id INTEGER, sum_sales DECIMAL(38,2), number_sales HUGEINT);` |  |
| `get_bit` | `unsupported feature` | 6 | sql/types/bit/test_bit_functions.test | `query I<br>SELECT get_bit('110'::BIT, 2)<br>----<br>0` |  |
| `hosts` | `unsupported feature` | 1 | sql/types/nested/list/list_aggregate_dict.test | `statement ok<br>CREATE TABLE Hosts (ips varchar[]);` |  |
| `huge_bits` | `unsupported feature` | 1 | sql/types/bit/test_bit.test | `statement ok<br>CREATE TABLE huge_bits (big bit);` |  |
| `hugeints2` | `unsupported feature` | 1 | sql/types/hugeint/test_hugeint_ops.test | `statement ok<br>CREATE TABLE hugeints2(h HUGEINT);<br>INSERT INTO hugeints2 VALUES (42::HUGEINT);` |  |
| `icu_calendar_names` | `unsupported feature` | 1 | sql/timezone/test_icu_calendar.test | `query I<br>SELECT name FROM icu_calendar_names()<br>GROUP BY 1<br>ORDER BY 1;<br>----<br>buddhist<br>chinese<br>coptic<br>dangi<br>ethiopic<br>ethiopic-amete-alem<br>gregorian<br>hebrew<br>indian<br>islamic<br>islamic-civil<br>islamic-rgsa<br>islamic-tbla<br>islamic-umalqura<br>iso8601<br>japanese<br>persian<br>roc` |  |
| `integer` | `unsupported feature` | 1 | sql/types/decimal/test_decimal.test | `statement error<br>SELECT '1'::INTEGER(1000);` |  |
| `ints` | `unsupported feature` | 1 | sql/types/map/map_const_and_col_combination.test | `statement ok<br>CREATE TABLE ints (i INT);` |  |
| `invalid` | `unsupported feature` | 1 | sql/types/bit/test_hex_to_bit.test | `statement ok<br>CREATE TABLE invalid (v VARCHAR);` |  |
| `issue14384` | `unsupported feature` | 3 | sql/types/interval/test_interval_comparison.test | `statement ok<br>CREATE TABLE issue14384(i INTERVAL);` |  |
| `issue1998` | `unsupported feature` | 1 | sql/types/interval/test_interval_addition.test | `statement ok<br>CREATE TABLE issue1998(id INTEGER, lhs TIMESTAMP, rhs TIMESTAMP);` |  |
| `issue2241` | `unsupported feature` | 1 | sql/transactions/test_index_transaction_local.test | `statement ok<br>CREATE TABLE issue2241 (id text primary key);` |  |
| `join_table` | `unsupported feature` | 1 | sql/table_function/test_table_function.test | `statement ok<br>CREATE TABLE join_table(name VARCHAR, value INTEGER);` |  |
| `keys` | `unsupported feature` | 1 | sql/transactions/aborted_transaction_commit.test | `statement ok<br>CREATE TABLE keys(i INTEGER PRIMARY KEY);` |  |
| `large_enum_tbl` | `unsupported feature` | 1 | sql/types/enum/test_enum_table.test | `statement ok<br>CREATE TABLE large_enum_tbl (<br>    big_word large_enum<br>);` |  |
| `lineitem2` | `unsupported feature` | 1 | sql/types/enum/test_5983.test | `statement ok<br>CREATE TABLE lineitem2 (comment l_comment_enum);` |  |
| `linestring` | `unsupported feature` | 2 | sql/types/geo/geometry_shred.test | `statement ok<br>INSERT INTO t1 VALUES ('LINESTRING(0 0, 1 1)'::GEOMETRY);` |  |
| `list_array_table` | `unsupported feature` | 1 | sql/types/nested/list/test_list_extract.test | `statement ok<br>CREATE TABLE list_array_table(a int[3][]);` |  |
| `list_element` | `unsupported feature` | 1 | sql/types/nested/list/test_list_extract.test | `query I<br>SELECT LIST_ELEMENT(LIST_VALUE(42), 1)<br>----<br>42` |  |
| `list_grade_up` | `unsupported feature` | 1 | sql/types/nested/list/test_list_functions_with_null_structs.test | `query I<br>SELECT list_grade_up(str) FROM struct_data;<br>----<br>NULL` |  |
| `list_reverse_sort` | `unsupported feature` | 1 | sql/types/nested/list/test_list_functions_with_null_structs.test | `query I<br>SELECT list_reverse_sort(str) FROM struct_data;<br>----<br>NULL` |  |
| `listdata` | `unsupported feature` | 1 | sql/types/nested/list/test_list_slice.test | `statement ok<br>CREATE TABLE listdata (<br>    c0 char(1),<br>    c1 char(1),<br>    c2 char(1),<br>    c3 char(1),<br>    c4 char(1),<br>    off integer,<br>    length integer)` |  |
| `m_2` | `unsupported feature` | 1 | sql/types/enum/test_3479.test | `statement ok<br>CREATE TABLE m_2 (<br>    m mood_2<br>);` |  |
| `many_structs_data` | `unsupported feature` | 1 | sql/types/nested/list/test_list_functions_with_null_structs.test | `statement ok<br>CREATE TABLE many_structs_data(str1 STRUCT(val VARCHAR, str2 STRUCT(val INT[]))[]);` |  |
| `map_from_entries` | `unsupported feature` | 39 | sql/types/nested/map/map_from_entries/column.test<br>sql/types/nested/map/map_from_entries/column_null_entry.test<br>sql/types/nested/map/map_from_entries/data_types.test<br>sql/types/nested/map/map_from_entries/dictionary_vector.test | `statement error<br>SELECT MAP_FROM_ENTRIES(list) FROM t1;` |  |
| `map_input` | `unsupported feature` | 1 | sql/types/map/map_const_and_col_combination.test | `statement ok<br>CREATE TABLE MAP_input (keys INT[], values INT[]);` |  |
| `midenum_t` | `unsupported feature` | 1 | sql/types/enum/test_enum_table.test | `statement ok<br>CREATE TABLE midenum_t (<br>    test midenum<br>);` |  |
| `midenum_t2` | `unsupported feature` | 1 | sql/types/enum/test_enum_table.test | `statement ok<br>CREATE TABLE midenum_t2 (<br>    test_2 midenum_2<br>);` |  |
| `mixed_values` | `unsupported feature` | 1 | sql/types/bignum/test_bignum_sum.test | `statement ok<br>CREATE TABLE mixed_values(x BIGNUM);` |  |
| `multipoint` | `unsupported feature` | 2 | sql/types/geo/geometry.test<br>sql/types/geo/geometry_shred_empty.test | `query I<br>SELECT 'MULTIPOINT(EMPTY, 2 2, EMPTY)'::GEOMETRY::VARCHAR;<br>----<br>MULTIPOINT (EMPTY, 2 2, EMPTY)` |  |
| `nested_struct` | `unsupported feature` | 1 | sql/topn/test_top_n_nested_struct.test | `statement ok<br>CREATE TABLE nested_struct(cik BIGINT, entityName VARCHAR, a STRUCT(b STRUCT(c INT, d INT), c STRUCT(e INT, f INT)));` |  |
| `nested_struct_data` | `unsupported feature` | 1 | sql/types/nested/list/test_list_functions_with_null_structs.test | `statement ok<br>CREATE TABLE nested_struct_data(str STRUCT(str_nested STRUCT(val VARCHAR))[]);` |  |
| `null_keys_list` | `unsupported feature` | 1 | sql/types/nested/map/map_error.test | `statement ok<br>CREATE TABLE null_keys_list (k INT[], v INT[]);` |  |
| `null_values_list` | `unsupported feature` | 1 | sql/types/nested/map/map_error.test | `statement ok<br>CREATE TABLE null_values_list (k INT[], v INT[]);` |  |
| `person_pet` | `unsupported feature` | 1 | sql/types/enum/test_enum_comparisons.test | `statement ok<br>CREATE TABLE person_pet (<br>    person_name text,<br>    pet_name text<br>);` |  |
| `person_string` | `unsupported feature` | 1 | sql/types/enum/test_enum_table.test | `statement ok<br>CREATE TABLE person_string (<br>    name text,<br>    current_mood text<br>);` |  |
| `pet` | `unsupported feature` | 1 | sql/types/enum/test_enum_comparisons.test | `statement ok<br>CREATE TABLE pet (<br>    name text,<br>    current_mood pet_mood<br>);` |  |
| `pets` | `unsupported feature` | 2 | sql/types/alias/test_alias_table.test<br>sql/types/enum/test_enum_table.test | `statement ok<br>CREATE TABLE pets (<br>    name text,<br>    current_mood mood<br>);` |  |
| `pg_timezone_names` | `unsupported feature` | 3 | sql/timezone/test_icu_timezone.test | `query II<br>select utc_offset, is_dst<br>from pg_timezone_names() <br>where name = 'America/Asuncion'<br>----<br>-03:00:00	0` |  |
| `point` | `unsupported feature` | 23 | sql/types/geo/geometry.test<br>sql/types/geo/geometry_crs.test<br>sql/types/geo/geometry_intersects.test<br>sql/types/geo/geometry_shred.test<br>sql/types/geo/geometry_shred_fetch.test<br>sql/types/geo/geometry_shred_limit.test<br>sql/types/geo/geometry_shred_list.test<br>sql/types/geo/geometry_stats.test<br>sql/types/geo/geometry_wkb.test | `query I<br>select * from t2;<br>----<br>POINT (0 1)` |  |
| `power` | `unsupported feature` | 1 | sql/types/bignum/test_bignum_hugeint.test | `statement ok<br>create table t as select (10 * power(10,i))::hugeint as i from range (0,38) t(i)` |  |
| `read_text` | `unsupported feature` | 1 | sql/table_function/read_text_and_blob.test | `query IIII<br>SELECT * FROM read_text('test/sql/table_function/files/nonexistentfile.txt') ORDER BY ALL;<br>----` |  |
| `rebind_stmt` | `unsupported feature` | 1 | sql/types/nested/list/list_aggregates.test | `statement ok<br>EXECUTE rebind_stmt(10);` |  |
| `rnv` | `unsupported feature` | 2 | sql/types/list/unnest_aggregate.test | `statement ok<br>create or replace function rnv(a,b) as (select a + b * pi());` |  |
| `robots` | `unsupported feature` | 1 | sql/types/enum/test_enum_comparisons.test | `statement ok<br>CREATE TABLE robots (<br>    name text,<br>    current_mood mood<br>);` |  |
| `set_bit` | `unsupported feature` | 7 | sql/types/bit/test_bit_functions.test | `statement error<br>SELECT set_bit('011'::BIT, -1, 0)` |  |
| `src` | `unsupported feature` | 1 | sql/transactions/test_from_update_conflict.test | `statement ok<br>CREATE TABLE src(b INTEGER)` |  |
| `st_astext` | `unsupported feature` | 3 | sql/types/geo/geometry_shred.test<br>sql/types/geo/geometry_wkb.test | `query I<br>SELECT ST_AsText(g) FROM t1;<br>----<br>POINT (1 2)` |  |
| `st_crs` | `unsupported feature` | 3 | sql/types/geo/geometry_crs.test | `query I<br>select st_crs(NULL);<br>----<br>NULL` |  |
| `st_geomfromwkb` | `unsupported feature` | 4 | sql/types/geo/geometry_wkb.test | `query II rowsort all_values<br>select id, st_geomfromwkb(('\x' \|\| regexp_replace(g, '(.{2})', '\1\\x', 'g')[:-3])::BLOB) FROM (VALUES<br>(1, '0101000000000000000000f03f0000000000000040'),<br>(2, '01e9030000000000000000f03f00000000000000400000000000000840'),<br>(3, '01d1070000000000000000f03f00000000000000400000000000001040'),<br>(4, '01b90b0000000000000000f03f000000000000004000000000000008400000000000001040'),<br>(5, '010200000002000000000000000000f03f000000000000004000000000000008400000000000001040'),<br>(6, '01ea03000002000000000000000000f03f00000000000000400000000000000840000000000000104000000000000014400000000000001840'),<br>(7, '01d207000002000000000000000000f03f00000000000000400000000000001040000000000000104000000000000014400000000000001c40'),<br>(8, '01ba0b000002000000000000000000f03f0000000000000040000000000000084000000000000010400000000000001040000000000000144000000000000018400000000000001c40'),<br>(9, '01030000000100000004000000000000000000f03f00000000000000400000000000000840000000000000104000000000000014400000000000001840000000000000f03f0000000000000040'),<br>(10,'01eb0300000100000004000000000000000000f03f00000000000000400000000000000840000000000000084000000000000010400000000000001440000000000000144000000000000018400000000000001c40000000000000f03f00000000000000400000000000000840'),<br>(11,'01d30700000100000004000000000000000000f03f00000000000000400000000000001040000000000000084000000000000010400000000000001840000000000000144000000000000018400000000000002040000000000000f03f00000000000000400000000000001040'),<br>(12,''),<br>(13,'0104000000030000000101000000000000000000f03f0000000000000040010100000000000000000008400000000000001040010100000000000000000014400000000000001840'),<br>(14,'01ec0300000300000001e9030000000000000000f03f0000000000000040000000000000084001e903000000000000000008400000000000001040000000000000144001e9030000000000000000144000000000000018400000000000001c40'),<br>(15,'01d40700000300000001d1070000000000000000f03f0000000000000040000000000000104001d107000000000000000008400000000000001040000000000000184001d1070000000000000000144000000000000018400000000000002040'),<br>(16,'01bc0b00000300000001b90b0000000000000000f03f00000000000000400000000000000840000000000000104001b90b0000000000000000084000000000000010400000000000001440000000000000184001b90b0000000000000000144000000000000018400000000000001c400000000000002040'),<br>(17,'010500000002000000010200000002000000000000000000f03f000000000000004000000000000008400000000000001040010200000002000000000000000000144000000000000018400000000000001c400000000000002040'),<br>(18,'01ed0300000200000001ea03000002000000000000000000f03f0000000000000040000000000000084000000000000008400000000000001040000000000000144001ea03000002000000000000000000144000000000000018400000000000001c400000000000001c4000000000000020400000000000002240'),<br>(19,'01d50700000200000001d207000002000000000000000000f03f0000000000000040000000000000104000000000000008400000000000001040000000000000184001d2070000020000000000000000001440000000000000184000000000000020400000000000001c4000000000000020400000000000002440'),<br>(20,''),<br>(21,''),<br>(22,''),<br>(23,''),<br>(24,''),<br>(25,'0107000000020000000101000000000000000000f03f00000000000000400102000000020000000000000000000840000000000000104000000000000014400000000000001840'),<br>(26,'01ef0300000200000001e9030000000000000000f03f0000000000000040000000000000084001ea03000002000000000000000000084000000000000010400000000000001440000000000000144000000000000018400000000000001c40'),<br>(27,'01d70700000200000001d1070000000000000000f03f0000000000000040000000000000104001d207000002000000000000000000084000000000000010400000000000001840000000000000144000000000000018400000000000002040'),<br>(28,'01bf0b00000200000001b90b0000000000000000f03f00000000000000400000000000000840000000000000104001ba0b0000020000000000000000000840000000000000104000000000000014400000000000001840000000000000144000000000000018400000000000001c400000000000002040'))<br>	as t(id, g) order by id;<br>----` |  |
| `st_setcrs` | `unsupported feature` | 2 | sql/types/geo/geometry_crs.test | `statement error<br>select st_setcrs(g, srid) from t3;` |  |
| `struct_data_two_lists` | `unsupported feature` | 1 | sql/types/nested/list/test_list_functions_with_null_structs.test | `statement ok<br>CREATE TABLE struct_data_two_lists(str STRUCT(val VARCHAR)[][]);` |  |
| `t_all_types` | `unsupported feature` | 1 | sql/types/geo/geometry_wkb.test | `statement ok<br>create table t_all_types(id INT, g GEOMETRY);` |  |
| `tbl_temp` | `unsupported feature` | 1 | sql/types/enum/test_enum_temp_tbl.test | `statement ok<br>CREATE TEMP TABLE tbl_temp (name varchar , cur_mood mood);` |  |
| `test_array` | `unsupported feature` | 1 | sql/types/nested/array/array_joins_2.test | `statement ok<br>CREATE TABLE test_array (c1 int[3]);` |  |
| `timezone` | `unsupported feature` | 1 | sql/timezone/test_icu_timezone.test | `query I<br>select timezone('America/Phoenix', '12:15:37.123456-08'::TIMETZ);<br>----<br>13:15:37.123456-07` |  |
| `to_centuries` | `unsupported feature` | 2 | sql/types/interval/interval_constants.test | `statement ok<br>select to_centuries(84::BIGINT);` |  |
| `to_days` | `unsupported feature` | 2 | sql/types/interval/interval_constants.test | `statement ok<br>select to_days(84::BIGINT);` |  |
| `to_decades` | `unsupported feature` | 2 | sql/types/interval/interval_constants.test | `statement ok<br>select to_decades(84::BIGINT);` |  |
| `to_millennia` | `unsupported feature` | 2 | sql/types/interval/interval_constants.test | `statement ok<br>select to_millennia(84::BIGINT);` |  |
| `to_months` | `unsupported feature` | 2 | sql/types/interval/interval_constants.test | `statement ok<br>select to_months(84::BIGINT);` |  |
| `to_quarters` | `unsupported feature` | 2 | sql/types/interval/interval_constants.test | `statement ok<br>select to_quarters(84::BIGINT);` |  |
| `to_weeks` | `unsupported feature` | 2 | sql/types/interval/interval_constants.test | `statement ok<br>select to_weeks(84::BIGINT);` |  |
| `topn_nulls` | `unsupported feature` | 1 | sql/topn/topn_nulls_first.test | `statement ok<br>CREATE TABLE topn_nulls(v INTEGER)` |  |
| `unlist` | `unsupported feature` | 1 | sql/types/nested/list/test_nested_list.test | `query I<br>SELECT UNLIST(LIST(42))<br>----<br>42` |  |
| `valid` | `unsupported feature` | 1 | sql/types/bit/test_hex_to_bit.test | `statement ok<br>CREATE TABLE valid (v VARCHAR);` |  |
| `wide` | `unsupported feature` | 1 | sql/table_function/test_information_schema_columns.test | `statement ok<br>CREATE TABLE wide (<br>  col0 varchar,<br>  col1 int,<br>  col2 time,<br>  col3 time,<br>  col4 bigint,<br>  col5 bigint,<br>  col6 varchar,<br>  col7 time,<br>  col8 varchar,<br>  col9 int,<br>  col10 bigint,<br>  col11 time,<br>  col12 time,<br>  col13 varchar,<br>  col14 time,<br>  col15 varchar,<br>  col16 varchar,<br>  col17 int,<br>  col18 time,<br>  col19 int,<br>  col20 bigint,<br>  col21 time,<br>  col22 int,<br>  col23 bigint,<br>  col24 varchar,<br>  col25 varchar,<br>  col26 bigint,<br>  col27 time,<br>  col28 bigint,<br>  col29 time,<br>  col30 varchar,<br>  col31 int,<br>  col32 int,<br>  col33 varchar,<br>  col34 bigint,<br>  col35 varchar,<br>  col36 bigint,<br>  col37 varchar,<br>  col38 int,<br>  col39 time,<br>  col40 time,<br>  col41 time,<br>  col42 bigint,<br>  col43 varchar,<br>  col44 bigint,<br>  col45 int,<br>  col46 time,<br>  col47 int,<br>  col48 int,<br>  col49 varchar,<br>  col50 varchar,<br>  col51 int,<br>  col52 time,<br>  col53 varchar,<br>  col54 varchar,<br>  col55 varchar,<br>  col56 bigint,<br>  col57 time,<br>  col58 bigint,<br>  col59 time,<br>  col60 time,<br>  col61 varchar,<br>  col62 varchar,<br>  col63 time,<br>  col64 varchar,<br>  col65 varchar,<br>  col66 bigint,<br>  col67 int,<br>  col68 bigint,<br>  col69 varchar,<br>  col70 int,<br>  col71 varchar,<br>  col72 bigint,<br>  col73 bigint,<br>  col74 varchar,<br>  col75 time,<br>  col76 varchar,<br>  col77 int,<br>  col78 time,<br>  col79 varchar,<br>  col80 bigint,<br>  col81 int,<br>  col82 bigint,<br>  col83 bigint,<br>  col84 bigint,<br>  col85 time,<br>  col86 bigint,<br>  col87 time,<br>  col88 time,<br>  col89 int,<br>  col90 bigint,<br>  col91 bigint,<br>  col92 int,<br>  col93 int,<br>  col94 time,<br>  col95 varchar,<br>  col96 varchar,<br>  col97 varchar,<br>  col98 varchar,<br>  col99 int,<br>  col100 varchar,<br>  col101 int,<br>  col102 time,<br>  col103 varchar,<br>  col104 bigint,<br>  col105 varchar,<br>  col106 int,<br>  col107 varchar,<br>  col108 time,<br>  col109 time,<br>  col110 bigint,<br>  col111 int,<br>  col112 time,<br>  col113 int,<br>  col114 time,<br>  col115 int,<br>  col116 int,<br>  col117 time,<br>  col118 varchar,<br>  col119 bigint,<br>  col120 time,<br>  col121 int,<br>  col122 int,<br>  col123 varchar,<br>  col124 varchar,<br>  col125 bigint,<br>  col126 varchar,<br>  col127 varchar,<br>  col128 bigint,<br>  col129 time,<br>  col130 time,<br>  col131 int,<br>  col132 varchar,<br>  col133 varchar,<br>  col134 bigint,<br>  col135 int,<br>  col136 int,<br>  col137 bigint,<br>  col138 time,<br>  col139 time,<br>  col140 varchar,<br>  col141 varchar,<br>  col142 time,<br>  col143 varchar,<br>  col144 bigint,<br>  col145 bigint,<br>  col146 time,<br>  col147 varchar,<br>  col148 bigint,<br>  col149 bigint,<br>  col150 time,<br>  col151 varchar,<br>  col152 varchar,<br>  col153 time,<br>  col154 time,<br>  col155 varchar,<br>  col156 time,<br>  col157 varchar,<br>  col158 bigint,<br>  col159 time,<br>  col160 time,<br>  col161 varchar,<br>  col162 int,<br>  col163 time,<br>  col164 bigint,<br>  col165 time,<br>  col166 int,<br>  col167 int,<br>  col168 int,<br>  col169 bigint,<br>  col170 int,<br>  col171 varchar,<br>  col172 varchar,<br>  col173 int,<br>  col174 time,<br>  col175 int,<br>  col176 bigint,<br>  col177 time,<br>  col178 int,<br>  col179 int,<br>  col180 int,<br>  col181 bigint,<br>  col182 varchar,<br>  col183 int,<br>  col184 time,<br>  col185 time,<br>  col186 bigint,<br>  col187 bigint,<br>  col188 varchar,<br>  col189 varchar,<br>  col190 bigint,<br>  col191 int,<br>  col192 int,<br>  col193 int,<br>  col194 int,<br>  col195 varchar,<br>  col196 varchar,<br>  col197 time,<br>  col198 varchar,<br>  col199 bigint,<br>  col200 varchar,<br>  col201 time,<br>  col202 varchar,<br>  col203 bigint,<br>  col204 bigint,<br>  col205 int,<br>  col206 varchar,<br>  col207 bigint,<br>  col208 bigint,<br>  col209 time,<br>  col210 varchar,<br>  col211 int,<br>  col212 varchar,<br>  col213 int,<br>  col214 bigint,<br>  col215 int,<br>  col216 int,<br>  col217 bigint,<br>  col218 int,<br>  col219 int,<br>  col220 int,<br>  col221 int,<br>  col222 varchar,<br>  col223 varchar,<br>  col224 bigint,<br>  col225 bigint,<br>  col226 int,<br>  col227 varchar,<br>  col228 int,<br>  col229 varchar,<br>  col230 bigint,<br>  col231 varchar,<br>  col232 time,<br>  col233 bigint,<br>  col234 bigint,<br>  col235 time,<br>  col236 int,<br>  col237 time,<br>  col238 int,<br>  col239 bigint,<br>  col240 bigint,<br>  col241 int,<br>  col242 time,<br>  col243 int,<br>  col244 time,<br>  col245 bigint,<br>  col246 time,<br>  col247 varchar,<br>  col248 varchar,<br>  col249 int,<br>  col250 bigint,<br>  col251 varchar,<br>  col252 varchar,<br>  col253 bigint,<br>  col254 varchar,<br>  col255 varchar,<br>  col256 varchar,<br>  col257 bigint,<br>  col258 time,<br>  col259 time,<br>  col260 varchar,<br>  col261 int,<br>  col262 varchar,<br>  col263 int,<br>  col264 bigint,<br>  col265 varchar,<br>  col266 int,<br>  col267 varchar,<br>  col268 varchar,<br>  col269 time,<br>  col270 bigint,<br>  col271 bigint,<br>  col272 bigint,<br>  col273 varchar,<br>  col274 varchar,<br>  col275 time,<br>  col276 time,<br>  col277 int,<br>  col278 bigint,<br>  col279 int,<br>  col280 bigint,<br>  col281 int,<br>  col282 varchar,<br>  col283 varchar,<br>  col284 varchar,<br>  col285 time,<br>  col286 bigint,<br>  col287 bigint,<br>  col288 int,<br>  col289 varchar,<br>  col290 bigint,<br>  col291 varchar,<br>  col292 time,<br>  col293 varchar,<br>  col294 time,<br>  col295 time,<br>  col296 bigint,<br>  col297 int,<br>  col298 bigint,<br>  col299 int,<br>  col300 time,<br>  col301 time,<br>  col302 varchar,<br>  col303 int,<br>  col304 bigint,<br>  col305 bigint,<br>  col306 int,<br>  col307 bigint,<br>  col308 bigint,<br>  col309 bigint,<br>  col310 bigint,<br>  col311 varchar,<br>  col312 time,<br>  col313 bigint,<br>  col314 time,<br>  col315 int,<br>  col316 varchar,<br>  col317 bigint,<br>  col318 time,<br>  col319 int,<br>  col320 int,<br>  col321 bigint,<br>  col322 int,<br>  col323 time,<br>  col324 time,<br>  col325 int,<br>  col326 time,<br>  col327 bigint,<br>  col328 int,<br>  col329 bigint,<br>  col330 int,<br>  col331 int,<br>  col332 int,<br>  col333 varchar,<br>  col334 bigint,<br>  col335 time,<br>  col336 int,<br>  col337 bigint,<br>  col338 time,<br>  col339 bigint,<br>  col340 time,<br>  col341 bigint,<br>  col342 varchar,<br>  col343 bigint,<br>  col344 time,<br>  col345 bigint,<br>  col346 time,<br>  col347 bigint,<br>  col348 int,<br>  col349 varchar,<br>  col350 varchar,<br>  col351 int,<br>  col352 varchar,<br>  col353 bigint,<br>  col354 int,<br>  col355 varchar,<br>  col356 int,<br>  col357 int,<br>  col358 varchar,<br>  col359 varchar,<br>  col360 time,<br>  col361 bigint,<br>  col362 varchar,<br>  col363 bigint,<br>  col364 varchar,<br>  col365 time,<br>  col366 varchar,<br>  col367 varchar,<br>  col368 varchar,<br>  col369 varchar,<br>  col370 bigint,<br>  col371 bigint,<br>  col372 time,<br>  col373 time,<br>  col374 varchar,<br>  col375 bigint,<br>  col376 varchar,<br>  col377 int,<br>  col378 bigint,<br>  col379 varchar,<br>  col380 int,<br>  col381 int,<br>  col382 varchar,<br>  col383 varchar,<br>  col384 time,<br>  col385 time,<br>  col386 varchar,<br>  col387 varchar,<br>  col388 varchar,<br>  col389 bigint,<br>  col390 varchar,<br>  col391 int,<br>  col392 varchar,<br>  col393 bigint,<br>  col394 time,<br>  col395 time,<br>  col396 int,<br>  col397 bigint,<br>  col398 varchar,<br>  col399 time,<br>  col400 varchar,<br>  col401 varchar,<br>  col402 time,<br>  col403 bigint,<br>  col404 varchar,<br>  col405 time,<br>  col406 time,<br>  col407 varchar,<br>  col408 time,<br>  col409 time,<br>  col410 varchar,<br>  col411 time,<br>  col412 bigint,<br>  col413 varchar,<br>  col414 time,<br>  col415 bigint,<br>  col416 time,<br>  col417 varchar,<br>  col418 varchar,<br>  col419 int,<br>  col420 bigint,<br>  col421 bigint,<br>  col422 time,<br>  col423 varchar,<br>  col424 time,<br>  col425 int,<br>  col426 time,<br>  col427 time,<br>  col428 varchar,<br>  col429 bigint,<br>  col430 time,<br>  col431 varchar,<br>  col432 varchar,<br>  col433 int,<br>  col434 int,<br>  col435 varchar,<br>  col436 time,<br>  col437 time,<br>  col438 time,<br>  col439 int,<br>  col440 varchar,<br>  col441 int,<br>  col442 bigint,<br>  col443 int,<br>  col444 bigint,<br>  col445 bigint,<br>  col446 time,<br>  col447 varchar,<br>  col448 int,<br>  col449 time,<br>  col450 varchar,<br>  col451 int,<br>  col452 varchar,<br>  col453 int,<br>  col454 varchar,<br>  col455 varchar,<br>  col456 bigint,<br>  col457 time,<br>  col458 bigint,<br>  col459 int,<br>  col460 bigint,<br>  col461 int,<br>  col462 varchar,<br>  col463 time,<br>  col464 varchar,<br>  col465 int,<br>  col466 bigint,<br>  col467 varchar,<br>  col468 int,<br>  col469 bigint,<br>  col470 time,<br>  col471 int,<br>  col472 varchar,<br>  col473 bigint,<br>  col474 bigint,<br>  col475 bigint,<br>  col476 varchar,<br>  col477 time,<br>  col478 bigint,<br>  col479 time,<br>  col480 int,<br>  col481 int,<br>  col482 bigint,<br>  col483 int,<br>  col484 varchar,<br>  col485 int,<br>  col486 int,<br>  col487 bigint,<br>  col488 bigint,<br>  col489 varchar,<br>  col490 int,<br>  col491 int,<br>  col492 bigint,<br>  col493 varchar,<br>  col494 time,<br>  col495 int,<br>  col496 bigint,<br>  col497 varchar,<br>  col498 varchar,<br>  col499 varchar,<br>  col500 time,<br>  col501 int,<br>  col502 varchar,<br>  col503 int,<br>  col504 time,<br>  col505 bigint,<br>  col506 bigint,<br>  col507 int,<br>  col508 bigint,<br>  col509 bigint,<br>  col510 bigint,<br>  col511 time,<br>  col512 varchar,<br>  col513 time,<br>  col514 int,<br>  col515 time,<br>  col516 time,<br>  col517 bigint,<br>  col518 int,<br>  col519 time,<br>  col520 varchar,<br>  col521 int,<br>  col522 int,<br>  col523 int,<br>  col524 bigint,<br>  col525 time,<br>  col526 time,<br>  col527 varchar,<br>  col528 time,<br>  col529 time,<br>  col530 varchar,<br>  col531 int,<br>  col532 bigint,<br>  col533 bigint,<br>  col534 int,<br>  col535 bigint,<br>  col536 varchar,<br>  col537 int,<br>  col538 time,<br>  col539 varchar,<br>  col540 bigint,<br>  col541 time,<br>  col542 bigint,<br>  col543 int,<br>  col544 time,<br>  col545 int,<br>  col546 bigint,<br>  col547 bigint,<br>  col548 int,<br>  col549 int,<br>  col550 time,<br>  col551 int,<br>  col552 time,<br>  col553 bigint,<br>  col554 int,<br>  col555 time,<br>  col556 bigint,<br>  col557 time,<br>  col558 bigint,<br>  col559 time,<br>  col560 varchar,<br>  col561 bigint,<br>  col562 int,<br>  col563 int,<br>  col564 bigint,<br>  col565 time,<br>  col566 bigint,<br>  col567 int,<br>  col568 bigint,<br>  col569 bigint,<br>  col570 int,<br>  col571 int,<br>  col572 bigint,<br>  col573 time,<br>  col574 varchar,<br>  col575 int,<br>  col576 int,<br>  col577 time,<br>  col578 time,<br>  col579 time,<br>  col580 varchar,<br>  col581 bigint,<br>  col582 varchar,<br>  col583 time,<br>  col584 varchar,<br>  col585 time,<br>  col586 bigint,<br>  col587 int,<br>  col588 time,<br>  col589 int,<br>  col590 bigint,<br>  col591 time,<br>  col592 varchar,<br>  col593 time,<br>  col594 bigint,<br>  col595 time,<br>  col596 time,<br>  col597 varchar,<br>  col598 time,<br>  col599 bigint,<br>  col600 int,<br>  col601 bigint,<br>  col602 int,<br>  col603 bigint,<br>  col604 int,<br>  col605 varchar,<br>  col606 varchar,<br>  col607 int,<br>  col608 bigint,<br>  col609 bigint,<br>  col610 time,<br>  col611 bigint,<br>  col612 time,<br>  col613 time,<br>  col614 int,<br>  col615 varchar,<br>  col616 bigint,<br>  col617 time,<br>  col618 time,<br>  col619 time,<br>  col620 time,<br>  col621 varchar,<br>  col622 bigint,<br>  col623 bigint,<br>  col624 varchar,<br>  col625 int,<br>  col626 varchar,<br>  col627 varchar,<br>  col628 time,<br>  col629 time,<br>  col630 bigint,<br>  col631 bigint,<br>  col632 int,<br>  col633 int,<br>  col634 varchar,<br>  col635 int,<br>  col636 bigint,<br>  col637 bigint,<br>  col638 int,<br>  col639 time,<br>  col640 time,<br>  col641 bigint,<br>  col642 varchar,<br>  col643 int,<br>  col644 time,<br>  col645 varchar,<br>  col646 time,<br>  col647 int,<br>  col648 int,<br>  col649 varchar,<br>  col650 time,<br>  col651 bigint,<br>  col652 bigint,<br>  col653 int,<br>  col654 time,<br>  col655 int,<br>  col656 int,<br>  col657 int,<br>  col658 bigint,<br>  col659 bigint,<br>  col660 time,<br>  col661 bigint,<br>  col662 int,<br>  col663 bigint,<br>  col664 bigint,<br>  col665 varchar,<br>  col666 varchar,<br>  col667 varchar,<br>  col668 time,<br>  col669 time,<br>  col670 varchar,<br>  col671 bigint,<br>  col672 int,<br>  col673 int,<br>  col674 bigint,<br>  col675 bigint,<br>  col676 bigint,<br>  col677 int,<br>  col678 varchar,<br>  col679 varchar,<br>  col680 varchar,<br>  col681 bigint,<br>  col682 varchar,<br>  col683 bigint,<br>  col684 int,<br>  col685 time,<br>  col686 int,<br>  col687 time,<br>  col688 varchar,<br>  col689 time,<br>  col690 varchar,<br>  col691 varchar,<br>  col692 varchar,<br>  col693 bigint,<br>  col694 varchar,<br>  col695 varchar,<br>  col696 time,<br>  col697 time,<br>  col698 bigint,<br>  col699 varchar,<br>  col700 bigint,<br>  col701 int,<br>  col702 int,<br>  col703 time,<br>  col704 bigint,<br>  col705 time,<br>  col706 bigint,<br>  col707 int,<br>  col708 bigint,<br>  col709 int,<br>  col710 varchar,<br>  col711 time,<br>  col712 varchar,<br>  col713 bigint,<br>  col714 int,<br>  col715 time,<br>  col716 bigint,<br>  col717 time,<br>  col718 bigint,<br>  col719 varchar,<br>  col720 bigint,<br>  col721 time,<br>  col722 bigint,<br>  col723 int,<br>  col724 varchar,<br>  col725 time,<br>  col726 time,<br>  col727 int,<br>  col728 bigint,<br>  col729 int,<br>  col730 int,<br>  col731 time,<br>  col732 int,<br>  col733 int,<br>  col734 bigint,<br>  col735 varchar,<br>  col736 varchar,<br>  col737 varchar,<br>  col738 time,<br>  col739 bigint,<br>  col740 varchar,<br>  col741 int,<br>  col742 int,<br>  col743 bigint,<br>  col744 time,<br>  col745 bigint,<br>  col746 bigint,<br>  col747 time,<br>  col748 time,<br>  col749 time,<br>  col750 varchar,<br>  col751 int,<br>  col752 time,<br>  col753 int,<br>  col754 time,<br>  col755 int,<br>  col756 int,<br>  col757 bigint,<br>  col758 int,<br>  col759 time,<br>  col760 time,<br>  col761 time,<br>  col762 int,<br>  col763 bigint,<br>  col764 int,<br>  col765 bigint,<br>  col766 time,<br>  col767 int,<br>  col768 time,<br>  col769 time,<br>  col770 int,<br>  col771 varchar,<br>  col772 int,<br>  col773 bigint,<br>  col774 varchar,<br>  col775 time,<br>  col776 time,<br>  col777 bigint,<br>  col778 varchar,<br>  col779 int,<br>  col780 int,<br>  col781 int,<br>  col782 bigint,<br>  col783 int,<br>  col784 time,<br>  col785 time,<br>  col786 varchar,<br>  col787 int,<br>  col788 time,<br>  col789 int,<br>  col790 varchar,<br>  col791 varchar,<br>  col792 time,<br>  col793 bigint,<br>  col794 int,<br>  col795 int,<br>  col796 varchar,<br>  col797 time,<br>  col798 time,<br>  col799 bigint,<br>  col800 time,<br>  col801 time,<br>  col802 bigint,<br>  col803 time,<br>  col804 bigint,<br>  col805 bigint,<br>  col806 varchar,<br>  col807 time,<br>  col808 int,<br>  col809 int,<br>  col810 bigint,<br>  col811 varchar,<br>  col812 int,<br>  col813 time,<br>  col814 time,<br>  col815 int,<br>  col816 time,<br>  col817 varchar,<br>  col818 int,<br>  col819 int,<br>  col820 int,<br>  col821 int,<br>  col822 varchar,<br>  col823 int,<br>  col824 bigint,<br>  col825 int,<br>  col826 int,<br>  col827 bigint,<br>  col828 bigint,<br>  col829 varchar,<br>  col830 int,<br>  col831 varchar,<br>  col832 int,<br>  col833 varchar,<br>  col834 bigint,<br>  col835 bigint,<br>  col836 time,<br>  col837 time,<br>  col838 varchar,<br>  col839 int,<br>  col840 varchar,<br>  col841 int,<br>  col842 bigint,<br>  col843 time,<br>  col844 varchar,<br>  col845 varchar,<br>  col846 int,<br>  col847 int,<br>  col848 varchar,<br>  col849 time,<br>  col850 int,<br>  col851 int,<br>  col852 time,<br>  col853 time,<br>  col854 bigint,<br>  col855 time,<br>  col856 time,<br>  col857 time,<br>  col858 time,<br>  col859 varchar,<br>  col860 time,<br>  col861 time,<br>  col862 int,<br>  col863 int,<br>  col864 varchar,<br>  col865 bigint,<br>  col866 bigint,<br>  col867 time,<br>  col868 time,<br>  col869 varchar,<br>  col870 time,<br>  col871 time,<br>  col872 bigint,<br>  col873 time,<br>  col874 bigint,<br>  col875 bigint,<br>  col876 varchar,<br>  col877 bigint,<br>  col878 varchar,<br>  col879 time,<br>  col880 varchar,<br>  col881 bigint,<br>  col882 int,<br>  col883 varchar,<br>  col884 time,<br>  col885 time,<br>  col886 time,<br>  col887 varchar,<br>  col888 time,<br>  col889 time,<br>  col890 varchar,<br>  col891 varchar,<br>  col892 varchar,<br>  col893 time,<br>  col894 bigint,<br>  col895 varchar,<br>  col896 int,<br>  col897 bigint,<br>  col898 time,<br>  col899 time,<br>  col900 time,<br>  col901 varchar,<br>  col902 varchar,<br>  col903 int,<br>  col904 varchar,<br>  col905 time,<br>  col906 bigint,<br>  col907 time,<br>  col908 varchar,<br>  col909 time,<br>  col910 bigint,<br>  col911 varchar,<br>  col912 time,<br>  col913 int,<br>  col914 bigint,<br>  col915 varchar,<br>  col916 varchar,<br>  col917 bigint,<br>  col918 varchar,<br>  col919 time,<br>  col920 int,<br>  col921 bigint,<br>  col922 time,<br>  col923 bigint,<br>  col924 time,<br>  col925 varchar,<br>  col926 varchar,<br>  col927 varchar,<br>  col928 varchar,<br>  col929 bigint,<br>  col930 varchar,<br>  col931 int,<br>  col932 bigint,<br>  col933 int,<br>  col934 bigint,<br>  col935 bigint,<br>  col936 int,<br>  col937 bigint,<br>  col938 varchar,<br>  col939 time,<br>  col940 int,<br>  col941 time,<br>  col942 int,<br>  col943 varchar,<br>  col944 bigint,<br>  col945 time,<br>  col946 bigint,<br>  col947 varchar,<br>  col948 time,<br>  col949 time,<br>  col950 time,<br>  col951 int,<br>  col952 varchar,<br>  col953 bigint,<br>  col954 time,<br>  col955 varchar,<br>  col956 int,<br>  col957 bigint,<br>  col958 bigint,<br>  col959 bigint,<br>  col960 bigint,<br>  col961 int,<br>  col962 time,<br>  col963 varchar,<br>  col964 bigint,<br>  col965 varchar,<br>  col966 bigint,<br>  col967 time,<br>  col968 varchar,<br>  col969 time,<br>  col970 time,<br>  col971 time,<br>  col972 int,<br>  col973 int,<br>  col974 bigint,<br>  col975 bigint,<br>  col976 bigint,<br>  col977 time,<br>  col978 bigint,<br>  col979 varchar,<br>  col980 varchar,<br>  col981 bigint,<br>  col982 int,<br>  col983 bigint,<br>  col984 time,<br>  col985 bigint,<br>  col986 int,<br>  col987 bigint,<br>  col988 int,<br>  col989 bigint,<br>  col990 bigint,<br>  col991 time,<br>  col992 bigint,<br>  col993 bigint,<br>  col994 bigint,<br>  col995 int,<br>  col996 int,<br>  col997 int,<br>  col998 int,<br>  col999 varchar,<br>  col1000 time,<br>  col1001 bigint,<br>  col1002 bigint,<br>  col1003 bigint,<br>  col1004 time,<br>  col1005 varchar,<br>  col1006 varchar,<br>  col1007 varchar,<br>  col1008 int,<br>  col1009 bigint,<br>  col1010 bigint,<br>  col1011 time,<br>  col1012 bigint,<br>  col1013 time,<br>  col1014 int,<br>  col1015 varchar,<br>  col1016 time,<br>  col1017 time,<br>  col1018 int,<br>  col1019 varchar,<br>  col1020 varchar,<br>  col1021 int,<br>  col1022 bigint,<br>  col1023 time,<br>  col1024 bigint);` |  |
| `x1` | `unsupported feature` | 1 | sql/types/list/list_concat_null.test | `statement ok<br>CREATE table x1 (b INT[]);` |  |
| `zm` | `unsupported feature` | 1 | sql/types/geo/geometry_stats.test | `statement ok<br>insert into t1 values (6, 'MULTILINESTRING ZM ((0 0 -10 10, 1 1 -10 10), (2 2 2 1, 3 3 3 1))'::GEOMETRY);` |  |

---

# DuckDB Migration Issues

- Generated at (UTC): 2026-03-19T11:34:35.777755+00:00
- Scan root: `tests/sqllogictests/suites/duckdb_migrated`
- Tracked issues: 13
- Files with issues: 2360
- Unknown function TODOs: 1213
- Unsupported feature TODOs: 30056
- Unknown function unique issues: 2
- Unsupported feature unique issues: 3
...
| Function | Count | Files | Refs |
| --- | ---: | --- | --- |
| `current_localtime` | 1 | sql/timezone/test_icu_timezone.test |  |
| `current_localtimestamp` | 1 | sql/timezone/test_icu_timezone.test |  |
