...
fn test_array_arithmetic() {
    ...
    let tests = vec![
        ...
        ArrayTest {
            ...
            error: vec!["Internal Error: Unsupported (Utf8) minus (Utf8)"],
        },
        ArrayTest {
            name: "mul-passed",
            args: vec![
            ...
            error: vec!["Internal Error: Unsupported (Utf8) multiply (Utf8)"],
        },
        ArrayTest {
            name: "div-passed",
            args: vec![
            ...
            error: vec!["Internal Error: Unsupported (Utf8) divide (Utf8)"],
        },
    ];
