...
impl ITable for FunctionsTable {
    ...
    fn read_plan(&self, _push_down_plan: PlanNode) -> FuseQueryResult<ReadDataSourcePlan> {
    ...
    async fn read(&self, _parts: Vec<Partition>) -> FuseQueryResult<SendableDataBlockStream> {
