...
+ Sync {
    move |arg1, arg2, ctx| match (arg1, arg2) {
        ...
        (ValueRef::Column(arg1), ValueRef::Column(arg2)) => {
            let and_validity = ((&arg1.validity) & (&arg2.validity));
            let validity = ctx
                .validity
                .as_ref()
                .map(|valid| valid & (&and_validity))
...
+ Sync {
    move |arg1, arg2, arg3, ctx| match (arg1, arg2, arg3) {
        ...
        (ValueRef::Column(arg1), ValueRef::Scalar(Some(arg2)), ValueRef::Column(arg3)) => {
            let and_validity = ((&arg1.validity) & (&arg3.validity));
            let validity = ctx
                .validity
                .as_ref()
                .map(|valid| valid & (&and_validity))
        ...
        (ValueRef::Scalar(Some(arg1)), ValueRef::Column(arg2), ValueRef::Column(arg3)) => {
            let and_validity = ((&arg2.validity) & (&arg3.validity));
            let validity = ctx
                .validity
                .as_ref()
                .map(|valid| valid & (&and_validity))
        ...
        (ValueRef::Column(arg1), ValueRef::Column(arg2), ValueRef::Column(arg3)) => {
            let and_validity = ((&((&arg1.validity) & (&arg2.validity))) & (&arg3.validity));
            let validity = ctx
                .validity
                .as_ref()
                .map(|valid| valid & (&and_validity))
...
+ Sync {
    move |arg1, arg2, arg3, arg4, ctx| match (arg1, arg2, arg3, arg4) {
        ...
        (
            ...
            let and_validity = ((&arg1.validity) & (&arg4.validity));
            let validity = ctx
                .validity
                .as_ref()
                .map(|valid| valid & (&and_validity))
        ...
        (
            ...
            let and_validity = ((&arg2.validity) & (&arg4.validity));
            let validity = ctx
                .validity
                .as_ref()
                .map(|valid| valid & (&and_validity))
        ...
        (
            ...
            let and_validity = ((&((&arg1.validity) & (&arg2.validity))) & (&arg4.validity));
            let validity = ctx
                .validity
                .as_ref()
                .map(|valid| valid & (&and_validity))
        ...
        (
            ...
            let and_validity = ((&arg3.validity) & (&arg4.validity));
            let validity = ctx
                .validity
                .as_ref()
                .map(|valid| valid & (&and_validity))
        ...
        (
            ...
            let and_validity = ((&((&arg1.validity) & (&arg3.validity))) & (&arg4.validity));
            let validity = ctx
                .validity
                .as_ref()
                .map(|valid| valid & (&and_validity))
        ...
        (
            ...
            let and_validity = ((&((&arg2.validity) & (&arg3.validity))) & (&arg4.validity));
            let validity = ctx
                .validity
                .as_ref()
                .map(|valid| valid & (&and_validity))
...
+ Sync {
    move |arg1, arg2, arg3, arg4, arg5, ctx| match (arg1, arg2, arg3, arg4, arg5) {
        ...
        (
            ...
            let and_validity = ((&arg1.validity) & (&arg5.validity));
            let validity = ctx
                .validity
                .as_ref()
                .map(|valid| valid & (&and_validity))
        ...
        (
            ...
            let and_validity = ((&arg2.validity) & (&arg5.validity));
            let validity = ctx
                .validity
                .as_ref()
                .map(|valid| valid & (&and_validity))
        ...
        (
            ...
            let and_validity = ((&((&arg1.validity) & (&arg2.validity))) & (&arg5.validity));
            let validity = ctx
                .validity
                .as_ref()
                .map(|valid| valid & (&and_validity))
        ...
        (
            ...
            let and_validity = ((&arg3.validity) & (&arg5.validity));
            let validity = ctx
                .validity
                .as_ref()
                .map(|valid| valid & (&and_validity))
        ...
        (
            ...
            let and_validity = ((&((&arg1.validity) & (&arg3.validity))) & (&arg5.validity));
            let validity = ctx
                .validity
                .as_ref()
                .map(|valid| valid & (&and_validity))
        ...
        (
            ...
            let and_validity = ((&((&arg2.validity) & (&arg3.validity))) & (&arg5.validity));
            let validity = ctx
                .validity
                .as_ref()
                .map(|valid| valid & (&and_validity))
        ...
        (
            ...
            let and_validity = ((&arg4.validity) & (&arg5.validity));
            let validity = ctx
                .validity
                .as_ref()
                .map(|valid| valid & (&and_validity))
        ...
        (
            ...
            let and_validity = ((&((&arg1.validity) & (&arg4.validity))) & (&arg5.validity));
            let validity = ctx
                .validity
                .as_ref()
                .map(|valid| valid & (&and_validity))
        ...
        (
            ...
            let and_validity = ((&((&arg2.validity) & (&arg4.validity))) & (&arg5.validity));
            let validity = ctx
                .validity
                .as_ref()
                .map(|valid| valid & (&and_validity))
        ...
        (
            ...
            let and_validity = ((&((&arg3.validity) & (&arg4.validity))) & (&arg5.validity));
            let validity = ctx
                .validity
                .as_ref()
                .map(|valid| valid & (&and_validity))
