...
const _: () = {
    assert!(core::mem::size_of::<RowRef>() == core::mem::size_of::<RowMut>());
    assert!(core::mem::align_of::<RowRef>() == core::mem::align_of::<RowMut>());
};
...
impl RowMut {
    ...
    pub(super) fn into_ref(self) -> RowRef {
        RowRef::new(self.0.cast_const())
    }
