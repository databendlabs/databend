...
impl ValueType for IntervalType {
    type Scalar = (i32, i32, i64);
    type ScalarRef<'a> = (i32, i32, i64);
    type Column = Buffer<(i32, i32, i64)>;
    type Domain = SimpleDomain<(i32, i32, i64)>;
    type ColumnIterator<'a> = std::iter::Cloned<std::slice::Iter<'a, (i32, i32, i64)>>;
    type ColumnBuilder = Vec<(i32, i32, i64)>;

    #[inline]
    fn upcast_gat<'short, 'long: 'short>(long: (i32, i32, i64)) -> (i32, i32, i64) {
        long
    }
    ...
    fn try_downcast_domain(domain: &Domain) -> Option<SimpleDomain<(i32, i32, i64)>> {
    ...
    fn upcast_domain(domain: SimpleDomain<(i32, i32, i64)>) -> Domain {
...
impl ArgType for IntervalType {
    ...
    fn full_domain() -> Self::Domain {
        SimpleDomain {
            min: (-12 * 200, -365 * 200, -7200000000000000000),
            max: (12 * 200, 365 * 200, 7200000000000000000),
        }
    }
