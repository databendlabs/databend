...
//  Group by (nullable(u16), nullable(u8)) needs 16 + 8 + 1 + 1 = 26 bytes, then we pad the bytes up to u32 to store the hash value.
...
// ▼                     ▼                       ▼
// ┌──────────┬──────────┬───────────┬───────────┬───────────┬───────────┬───────────┬───────────┐
// │   8byte  │   8byte  │   8byte   │   1byte   │   1byte   │   1byte   │   .....   │   1byte   │
// └──────────┴──────────┴───────────┴───────────┴───────────┼───────────┴───────────┴───────────┤
//                                   ▲                       │                                   │
//                                   │                       └─────────► unused bytes  ◄─────────┘
