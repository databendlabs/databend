...
impl Binder {
    ...
    pub(crate) fn analyze_group_items(
        ...
        let original_group_by_alias_first = bind_context.group_by_alias_first;
        bind_context.group_by_alias_first =
            self.ctx.get_settings().get_enable_group_by_alias_first()?;
        ...
        bind_context.group_by_alias_first = original_group_by_alias_first;
        result
    }
