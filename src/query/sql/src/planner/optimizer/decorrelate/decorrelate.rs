...
impl SubqueryRewriter {
    ...
    pub fn try_decorrelate_simple_subquery(
        ...
        let filter_expr = RelExpr::with_s_expr(&subquery.subquery);
        let filter: Filter = subquery.subquery.plan().clone().try_into()?;
        ...
        let mut right_child = subquery.subquery.child(0)?.clone();
