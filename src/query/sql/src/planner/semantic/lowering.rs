...
mod tests {
    ...
    #[test]
    fn test_aaa() {
        let x = ScalarExpr::FunctionCall(FunctionCall {
            span: None,
            ...
            arguments: vec![
                ...
                ScalarExpr::ConstantExpr(ConstantExpr {
                    span: None,
                    value: databend_common_expression::Scalar::Number(NumberScalar::Int64(
                        869550529_i64,
                    )),
                }),
            ],
        ...
        let fields = vec![DataField::new("1", UInt64Type::data_type().wrap_nullable())];
        let schema = DataSchema::new(fields);

        let xxx = x.type_check(&schema);
