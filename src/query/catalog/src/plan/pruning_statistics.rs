...
impl PruningStatistics {
    pub fn merge(&mut self, other: &Self, use_max_for_segments: bool, use_max_for_blocks: bool) {
        ...
        if use_max_for_blocks {
            ...
            self.blocks_spatial_index_pruning_before = self
                .blocks_spatial_index_pruning_before
                .max(other.blocks_spatial_index_pruning_before);
            self.blocks_spatial_index_pruning_after = self
                .blocks_spatial_index_pruning_after
                .max(other.blocks_spatial_index_pruning_after);
