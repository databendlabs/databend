...
use crate::aggregates::aggregate_quantile_disc_v2::create_quantile_disc;
...
where
    ...
    T: Send + Sync + ArgType + ValueType + 'static,
{
    pub(crate) fn try_create(
        ...
        let func: AggregateUnaryFunction<S, T> = AggregateUnaryFunction {
...
pub fn try_create_aggregate_unary_function(
    ...
    match display_name {
        ...
        "quantile_disc_v2" => create_quantile_disc(display_name, params, arguments, data_type),
