    ...
    let tests = vec![
        ScalarFunctionTest {
            ...
            columns: vec![
                ...
                Series::from_data(vec![1_u32, 2, 3]),
            ],
            expect: Series::from_data(vec![Some(1_i64), Some(5_i64), Some(9_i64)]),
            error: "",
        },
        ScalarFunctionTest {
            ...
            columns: vec![
                ...
                Series::from_data(vec![1_u32, 1, 1]),
            ],
        ...
        ScalarFunctionTest {
            ...
            columns: vec![
                ...
                Series::from_data(vec![4_u32, 4, 4]),
            ],
