...
use databend_functions_scalar_datetime::datetime::auto_detect_date;
use databend_functions_scalar_datetime::datetime::auto_detect_timestamp;
use databend_functions_scalar_datetime::datetime::auto_detect_timestamp_tz;
...
fn test_parse_epoch_str_unit() {
    // seconds
    assert_eq!(parse_epoch_str("1487654321"), Some(1487654321_000_000));
    // milliseconds (> 31536000000)
    assert_eq!(parse_epoch_str("1487654321321"), Some(1487654321_321_000));
    // boundary: sec vs ms
    assert_eq!(parse_epoch_str("31535999999"), Some(31535999999_000_000));
    assert_eq!(parse_epoch_str("31536000001"), Some(31536000001_000));
    // negative
    assert_eq!(parse_epoch_str("-86400"), Some(-86400_000_000));
    // not a number
