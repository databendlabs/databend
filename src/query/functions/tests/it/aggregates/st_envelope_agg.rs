...
fn test_st_envelope_agg() {
    ...
    run_st_envelope_agg_cases(file, eval_aggregate);
}
        ...
        Case::Samples {
            ...
            samples: vec![
                ...
                Sample {
                    ...
                    state: tuple(vec![
                        binary(
                            "AQMAACDmEAAAAQAAAAUAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAACEAAAAAAAAAAAAAAAAAAAAhAAAAAAAAAAEAAAAAAAAAAAAAAAAAAAABAAAAAAAAAAAAAAAAAAAAAAA==",
                        ),
                        Scalar::Boolean(true),
                    ]),
                    result: geometry(
