...
#[test]
fn test_st_union_agg() {
    let mut mint = Mint::new("tests/it/aggregates/testdata");
    let file = &mut mint.new_goldenfile("st_union_agg.txt").unwrap();
    run_st_union_agg_cases(file, eval_legacy_aggregate);
}

#[test]
fn test_st_union_agg_group_by() {
    let mut mint = Mint::new("tests/it/aggregates/testdata");
