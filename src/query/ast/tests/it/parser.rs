...
fn test_statement() {
    ...
    let cases = &[
        ...
        r#"ALTER USER u1 WITH SET NETWORK_POLICY = 'policy1';"#,
        r#"ALTER USER u1 WITH UNSET NETWORK_POLICY;"#,
        r#"CREATE USER u1 IDENTIFIED BY '123456' WITH DEFAULT_ROLE='role123', TENANTSETTING"#,
        r#"CREATE USER u1 IDENTIFIED BY '123456' WITH SET NETWORK_POLICY='policy1'"#,
