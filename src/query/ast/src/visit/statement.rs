...
impl Walk for Statement {
    fn walk<V: Visitor + ?Sized>(
        ...
        match self {
            ...
            Statement::ShowShares(stmt) => try_walk!(stmt.walk(visitor)),
            Statement::DescShare(stmt) => try_walk!(stmt.walk(visitor)),
            Statement::CreateShare(stmt) => try_walk!(stmt.walk(visitor)),
            Statement::DropShare(stmt) => try_walk!(stmt.walk(visitor)),
            Statement::AlterShare(stmt) => try_walk!(stmt.walk(visitor)),
            Statement::GrantShare(stmt) => try_walk!(stmt.walk(visitor)),
            Statement::RevokeShare(stmt) => try_walk!(stmt.walk(visitor)),
            ...
            Statement::RefreshLineage(stmt) => try_walk!(stmt.walk(visitor)),
            Statement::CreateMaterializedView(stmt) => try_walk!(stmt.walk(visitor)),
            Statement::AlterMaterializedView(stmt) => try_walk!(stmt.walk(visitor)),
            Statement::DropMaterializedView(stmt) => try_walk!(stmt.walk(visitor)),
            Statement::RefreshMaterializedView(stmt) => try_walk!(stmt.walk(visitor)),
            Statement::ShowCreateMaterializedView(stmt) => try_walk!(stmt.walk(visitor)),
            Statement::ShowMaterializedViews(stmt) => try_walk!(stmt.walk(visitor)),
...
impl WalkMut for Statement {
    fn walk_mut<V: VisitorMut + ?Sized>(
        ...
        match self {
            ...
            Statement::ShowShares(stmt) => try_walk!(stmt.walk_mut(visitor)),
            Statement::DescShare(stmt) => try_walk!(stmt.walk_mut(visitor)),
            Statement::CreateShare(stmt) => try_walk!(stmt.walk_mut(visitor)),
            Statement::DropShare(stmt) => try_walk!(stmt.walk_mut(visitor)),
            Statement::AlterShare(stmt) => try_walk!(stmt.walk_mut(visitor)),
            Statement::GrantShare(stmt) => try_walk!(stmt.walk_mut(visitor)),
            Statement::RevokeShare(stmt) => try_walk!(stmt.walk_mut(visitor)),
            ...
            Statement::RefreshLineage(stmt) => try_walk!(stmt.walk_mut(visitor)),
            Statement::CreateMaterializedView(stmt) => try_walk!(stmt.walk_mut(visitor)),
            Statement::AlterMaterializedView(stmt) => try_walk!(stmt.walk_mut(visitor)),
            Statement::DropMaterializedView(stmt) => try_walk!(stmt.walk_mut(visitor)),
            Statement::RefreshMaterializedView(stmt) => try_walk!(stmt.walk_mut(visitor)),
            Statement::ShowCreateMaterializedView(stmt) => try_walk!(stmt.walk_mut(visitor)),
            Statement::ShowMaterializedViews(stmt) => try_walk!(stmt.walk_mut(visitor)),
