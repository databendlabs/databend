...
mod interpreter_virtual_columns_alter;
...
pub use interpreter_vector_index_set_para::SetVectorIndexParamInterpreter;
...
pub use interpreter_virtual_columns_alter::AlterVirtualColumnsInterpreter;
