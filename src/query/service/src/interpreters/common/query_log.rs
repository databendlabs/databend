...
impl InterpreterQueryLog {
    ...
    pub fn log_finish(
        ...
        let bytes_from_storage = data_cache_metrics.bytes_from_storage as u64;
        let bytes_from_disk_cache = data_cache_metrics.bytes_from_disk_cache as u64;
        let bytes_from_mem_cache = data_cache_metrics.bytes_from_mem_cache as u64;
