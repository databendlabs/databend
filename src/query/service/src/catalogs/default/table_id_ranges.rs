...
// min id for async funcs (inclusive)
pub const SYS_ASYNC_FUNC_ID_BEGIN: u64 = SYS_TBL_ID_END;
// max id for async tables (exclusive)
pub const SYS_ASYNC_FUC_ID_END: u64 = SYS_ASYNC_FUNC_ID_BEGIN + 10000;
