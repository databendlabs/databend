...
pub trait ClusterHelper {
    ...
    async fn create_node_conn(&self, name: &str, config: &Setting) -> Result<FlightClient>;
...
impl ClusterDiscovery {
    ...
    pub async fn create_meta_client(cfg: &Setting) -> Result<MetaStore> {
    ...
    pub async fn init(cfg: Setting) -> Result<()> {
    ...
    pub async fn try_create(cfg: &Setting, metastore: MetaStore) -> Result<Arc<ClusterDiscovery>> {
    ...
    pub async fn discover(&self, config: &Setting) -> Result<Arc<Cluster>> {
    ...
    pub async fn register_to_metastore(self: &Arc<Self>, cfg: &Setting) -> Result<()> {
...
pub async fn create_client(config: &Setting, address: &str) -> Result<FlightClient> {
