...
use databend_common_formats::field_encoder::FieldEncoderString;
...
impl serde::Serialize for BlocksSerializer {
    ...
    where S: serde::Serializer {
        ...
        if let Some(format) = &self.format {
            ...
            let encoder = FieldEncoderString::create(format);
...
impl serde::Serialize for RowSerializer<'_> {
    ...
    where S: serde::Serializer {
        ...
        for column in self.data_block.iter() {
            ...
            let string = self
                .encoder
                .write_field(column, self.row_index, false)
