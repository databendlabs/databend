...
pub struct OneFilePartition {
    pub path: String,
    pub size: usize,
}

#[typetag::serde(name = "text_part")]
impl PartInfo for OneFilePartition {
...
impl OneFilePartition {
    pub fn from_part(info: &PartInfoPtr) -> Result<&OneFilePartition> {
        info.as_any()
            .downcast_ref::<OneFilePartition>()
            .ok_or_else(|| {
