...
pub fn metrics_inc_remote_io_prewhere_milliseconds(c: u64) {
    increment_gauge!(key!("remote_io_prewhere_milliseconds"), c as f64);
}
...
pub fn metrics_reset() {
    ...
    gauge!(key!("remote_io_prewhere_milliseconds"), c);
}
