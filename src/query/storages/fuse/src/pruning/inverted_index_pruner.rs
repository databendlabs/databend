...
impl InvertedIndexPruner {
    pub fn try_create(
        ...
        if let Some(inverted_index_info) = inverted_index_info {
            ...
            let prepared = create_inverted_index_query(inverted_index_info, user_dictionary)?;
...
pub fn create_inverted_index_query(
    ...
    let tokenizer_manager =
        create_tokenizer_manager(&inverted_index_info.index_options, user_dictionary);
