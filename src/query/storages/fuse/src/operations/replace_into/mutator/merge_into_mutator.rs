...
use crate::metrics::metrics_inc_replace_block_number_partial_loaded;
...
use crate::metrics::metrics_inc_replace_row_number_partial_loaded;
...
impl AggregationContext {
    ...
    async fn apply_deletion_to_data_block(
        ...
        if delete_nums == block_meta.row_count as usize {
            ...
            let mutation = MutationLogEntry::Deleted {
        ...
        metrics_inc_replace_row_number_write(block_meta.row_count);
