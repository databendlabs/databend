    ...
    fn fetch_task_candidates(
        ...
        for plan in &plans {
            ...
            if properties.mode == ReclusterMode::Aggressive
                && !plan.score.passes_tail_efficiency_threshold()
            {
        ...
        debug!(
            "recluster: probed task candidates group={} block_count={} avg_depth={} depth_threshold={} max_depth={} peak_count={} peak_probe_count={} task_count={} rejected_tail_count={} rejected_conflict_count={}",
            group,
            block_count,
            average_depth,
