...
mod dummy {
    ...
    #[divan::bench]
    fn bench_u64(bencher: divan::Bencher) {
    ...
    #[divan::bench]
    fn bench_string(bencher: divan::Bencher) {
    ...
    #[divan::bench]
    fn bench_u64_using_digests(bencher: divan::Bencher) {
        let column = rand_i64_column(1_000_000);
    ...
    #[divan::bench]
    fn bench_string_using_digests(bencher: divan::Bencher) {
        let column = rand_str_column(1_000_000, 32);
