...
pub use vector::preprocess_vector;
pub use vector::vector_angular_distance;
pub use vector::vector_distance;
pub use vector::vector_distance_lower_bound;
pub use vector::vector_distance_type_from_index_option;
pub use vector::vector_distance_type_name;
pub use vector::vector_spheres_overlap;
pub use vector::vector_stat_distance;
pub use vector::vector_statistics_distance_type;
