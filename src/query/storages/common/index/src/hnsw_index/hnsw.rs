...
impl HNSWIndex {
    pub fn open(
        ...
        let encoded_vectors = EncodedVectorsU8::load(encoded_data, encoded_meta, &params)?;
    ...
    pub fn build(
        ...
        index_fields.push(TableField::new(
            &format!("{}-{}_encoded_meta", column_id, distance_type),
            TableDataType::Binary,
        ));
        index_fields.push(TableField::new(
            &format!("{}-{}_encoded_data", column_id, distance_type),
            TableDataType::Binary,
        ));
