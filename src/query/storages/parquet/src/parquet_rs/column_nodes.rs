...
#[derive(Debug, Clone)]
pub struct ColumnNodesRS {
    pub column_nodes: Vec<ColumnNodeRS>,
}
...
impl ColumnNodesRS {
    ...
    fn traverse_fields_dfs(
        ...
        match &field.data_type() {
            ...
            _ => {
                let column_node = ColumnNodeRS::new(field.clone(), is_nested, vec![*leaf_id], None);
                *leaf_id += 1;
                column_node
            }
        }
    ...
    pub fn traverse_path<'a>(
        column_nodes: &'a [ColumnNodeRS],
        path: &'a [usize],
    ) -> Result<&'a ColumnNodeRS> {
...
pub struct ColumnNodeRS {
    ...
    pub children: Option<Vec<ColumnNodeRS>>,
...
impl ColumnNodeRS {
    pub fn new(
        ...
        children: Option<Vec<ColumnNodeRS>>,
    ) -> Self {
        Self {
            field,
            is_nested,
