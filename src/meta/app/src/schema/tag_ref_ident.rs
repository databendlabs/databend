...
/// The key format is `__fd_tag_ref/<tenant>/<object_type>/<object_id>/<tag_name>`.
...
/// Tag reference key stored in meta-service.
///
/// Key format: `__fd_tag_ref/<tenant>/<object_type>/<object_id>/<tag_name>`
///
/// For tables, the object_id includes both `db_id` and `table_id` (e.g., `table/123/456/tag_name`)
