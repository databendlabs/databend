...
/// Unique numeric identifier for a tag definition.
pub type TagId = DataId<Resource>;

/// Key for looking up tag metadata by ID.
///
/// Key format: `__fd_tag_by_id/<tenant>/<tag_id>` -> [`TagMeta`]
///
/// This is part of a two-level indirection pattern:
/// - [`TagNameIdent`] (`__fd_tag/<tenant>/<name>`) -> `TagId`
/// - [`TagIdIdent`] (`__fd_tag_by_id/<tenant>/<id>`) -> `TagMeta`
///
/// This allows tag renames without updating all references.
///
/// [`TagNameIdent`]: crate::schema::TagNameIdent
/// [`TagMeta`]: crate::schema::TagMeta
