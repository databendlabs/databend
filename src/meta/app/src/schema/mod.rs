...
pub use table::DeleteTableLockRevReply;
...
pub use table::ListTableLockRevReply;
...
pub use table::UpsertTableLockRevReply;
pub use table::UpsertTableLockRevReq;
