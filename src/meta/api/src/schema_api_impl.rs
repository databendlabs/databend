...
impl<KV: kvapi::KVApi<Error = MetaError> + ?Sized> SchemaApi for KV {
    ...
    async fn get_sequence_next_value(
        ...
        crate::do_get_sequence_next_value(self, req).await
    }

    async fn drop_sequence(&self, req: DropSequenceReq) -> Result<DropSequenceReply, KVAppError> {
        crate::do_drop_sequence(self, req).await
    }
