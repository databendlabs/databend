...
use databend_common_meta_raft_store::sm_v002::adapter::upgrade_snapshot_data_v002_to_v003;
...
fn io_err_to_status(e: io::Error) -> Status {
    match e.kind() {
        io::ErrorKind::InvalidInput => return Status::invalid_argument(e.to_string()),
