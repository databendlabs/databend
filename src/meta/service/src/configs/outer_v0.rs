...
pub struct ConfigViaEnv {
    ...
    pub kvsrv_join_cluster_timeout: u64,
...
impl From<Config> for ConfigViaEnv {
    fn from(cfg: Config) -> ConfigViaEnv {
        Self {
            ...
            kvsrv_join_cluster_timeout: cfg.raft_config.join_cluster_timeout,
...
impl Into<Config> for ConfigViaEnv {
    fn into(self) -> Config {
        let raft_config = RaftConfig {
            ...
            join_cluster_timeout: self.kvsrv_join_cluster_timeout,
...
impl From<RaftConfig> for InnerRaftConfig {
    fn from(x: RaftConfig) -> InnerRaftConfig {
        InnerRaftConfig {
            ...
            join_cluster_timeout: x.join_cluster_timeout,
        }
    }
}
...
impl From<InnerRaftConfig> for RaftConfig {
    fn from(inner: InnerRaftConfig) -> Self {
        Self {
            ...
            join_cluster_timeout: inner.join_cluster_timeout,
        }
    }
}
