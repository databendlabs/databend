...
async fn test_export() -> anyhow::Result<()> {
    ...
    let want = vec![
        ...
        r#"["test-29000-raft_log",{"Logs":{"key":2,"value":{"log_id":{"term":1,"index":2},"payload":{"Normal":{"txid":null,"time_ms":1111111111111,"cmd":{"AddNode":{"node_id":0,"node":{"name":"0","endpoint":{"addr":"localhost","port":29000},"grpc_api_advertise_host":"127.0.0.1:29000"}}}}}}}}]"#,
        ...
        r#"["test-29000-state_machine/0",{"Nodes":{"key":0,"value":{"name":"0","endpoint":{"addr":"localhost","port":29000},"grpc_api_advertise_host":"127.0.0.1:29000"}}}]"#,
