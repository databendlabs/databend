...
#[test]
fn test_decode_v133_remove_sequence_meta_step() -> anyhow::Result<()> {
    let csv_file_format_params_v133 = vec![
        8, 11, 16, 1, 26, 2, 102, 100, 34, 2, 114, 100, 42, 6, 109, 121, 95, 110, 97, 110, 50, 1,
        124, 58, 1, 39, 66, 4, 78, 117, 108, 108, 72, 1, 82, 6, 83, 84, 82, 73, 78, 71, 90, 6, 98,
        97, 115, 101, 54, 52, 96, 1, 106, 4, 69, 87, 75, 84, 160, 6, 133, 1, 168, 6, 24,
    ];
    ...
    common::test_load_old(
        func_name!(),
        csv_file_format_params_v133.as_slice(),
        133,
        want(),
    )?;
