...
#[test]
fn test_decode_v45_index() -> anyhow::Result<()> {
    let index_v045 = vec![
        8, 7, 16, 1, 26, 23, 50, 48, 49, 53, 45, 48, 51, 45, 48, 57, 32, 50, 48, 58, 48, 48, 58,
        48, 57, 32, 85, 84, 67, 50, 55, 83, 69, 76, 69, 67, 84, 32, 97, 44, 32, 115, 117, 109, 40,
        98, 41, 32, 70, 82, 79, 77, 32, 100, 101, 102, 97, 117, 108, 116, 46, 116, 49, 32, 87, 72,
        69, 82, 69, 32, 97, 32, 62, 32, 51, 32, 71, 82, 79, 85, 80, 32, 66, 89, 32, 98, 160, 6, 45,
        168, 6, 24,
    ];
    ...
    common::test_load_old(func_name!(), index_v045.as_slice(), 45, want())?;
