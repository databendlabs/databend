...
fn test_v118_webhdfs_add_user_name() -> anyhow::Result<()> {
    // Encoded data of version 118 of databend_common_meta_app::principal::user_stage::StageInfo:
    ...
    let stage_info_v118 = vec![
        ...
        105, 108, 101, 115, 16, 1, 26, 34, 10, 32, 42, 30, 34, 20, 100, 97, 116, 97, 98, 101, 110,
        100, 95, 105, 115, 95, 112, 111, 119, 101, 114, 102, 117, 108, 48, 1, 160, 6, 118, 168, 6,
        24, 42, 11, 10, 2, 48, 2, 16, 142, 8, 24, 1, 56, 1, 50, 4, 116, 101, 115, 116, 56, 100, 66,
        29, 10, 8, 100, 97, 116, 97, 98, 101, 110, 100, 18, 11, 100, 97, 116, 97, 98, 101, 110,
        100, 46, 114, 115, 160, 6, 118, 168, 6, 24, 74, 10, 34, 8, 8, 2, 160, 6, 118, 168, 6, 24,
        82, 23, 49, 57, 55, 48, 45, 48, 49, 45, 48, 49, 32, 48, 48, 58, 48, 48, 58, 48, 48, 32, 85,
        84, 67, 160, 6, 118, 168, 6, 24,
    ];
    ...
    let want = || mt::principal::StageInfo {
        ...
        stage_params: mt::principal::StageParams {
            storage: StorageParams::Webhdfs(StorageWebhdfsConfig {
                ...
                user_name: "databend_is_powerful".to_string(),
                ..Default::default()
            }),
        },
        is_temporary: false,
    ...
    common::test_load_old(func_name!(), stage_info_v118.as_slice(), 118, want())?;
