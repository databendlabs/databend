...
fn test_decode_v76_role() -> anyhow::Result<()> {
    let role_info_v76 = vec![
        10, 2, 114, 49, 18, 210, 1, 10, 31, 10, 21, 58, 13, 10, 7, 100, 101, 102, 97, 117, 108,
        ...
        168, 6, 24, 16, 128, 128, 32, 160, 6, 76, 168, 6, 24, 10, 18, 10, 8, 10, 0, 160, 6, 76,
        168, 6, 24, 16, 2, 160, 6, 76, 168, 6, 24, 160, 6, 76, 168, 6, 24, 160, 6, 76, 168, 6, 24,
    ];
...
fn test_decode_v76_ownership() -> anyhow::Result<()> {
    ...
    let want = || mt::principal::OwnershipInfo {
        role: "r1".to_string(),
        object: OwnershipObject::Database("default".to_string(), 1),
    };
    common::test_pb_from_to(func_name!(), want())?;
