...
fn test_decode_v62_table_lock_meta() -> anyhow::Result<()> {
    let bytes = vec![
        10, 4, 110, 111, 100, 101, 18, 7, 115, 101, 115, 115, 105, 111, 110, 26, 23, 50, 48, 49,
        52, 45, 49, 49, 45, 50, 57, 32, 49, 50, 58, 48, 48, 58, 48, 57, 32, 85, 84, 67, 34, 23, 50,
        48, 49, 52, 45, 49, 49, 45, 50, 57, 32, 49, 50, 58, 48, 48, 58, 49, 53, 32, 85, 84, 67,
        160, 6, 62, 168, 6, 24,
    ];
