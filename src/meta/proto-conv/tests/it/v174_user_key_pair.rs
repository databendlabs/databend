...
fn test_decode_v174_auth_info_key_pair() -> anyhow::Result<()> {
    let auth_info_v174 = vec![
        34, 71, 10, 69, 10, 32, 77, 73, 73, 66, 73, 106, 65, 78, 66, 103, 107, 113, 104, 107, 105,
        71, 57, 119, 48, 66, 65, 81, 69, 70, 65, 65, 79, 67, 65, 81, 56, 65, 18, 11, 99, 105, 45,
        112, 105, 112, 101, 108, 105, 110, 101, 26, 20, 50, 48, 50, 54, 45, 48, 52, 45, 50, 56, 84,
        49, 50, 58, 48, 48, 58, 48, 48, 90, 160, 6, 174, 1, 168, 6, 24,
    ];
