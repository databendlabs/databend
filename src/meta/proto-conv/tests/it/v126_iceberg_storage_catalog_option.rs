...
fn test_v126_iceberg_storage_catalog_option() -> anyhow::Result<()> {
    let catalog_meta_v126 = vec![
        ...
        114, 101, 32, 97, 99, 99, 101, 115, 115, 32, 107, 101, 121, 26, 45, 10, 14, 65, 87, 83, 95,
        83, 69, 67, 82, 69, 84, 95, 75, 69, 89, 18, 27, 101, 118, 101, 110, 32, 109, 111, 114, 101,
    ...
    let want = || databend_common_meta_app::schema::CatalogMeta {
        catalog_option: CatalogOption::Iceberg(IcebergCatalogOption::Storage(
            IcebergStorageCatalogOption {
                address: "localhost:9000".to_string(),
                table_bucket_arn: "my-bucket".to_string(),
                props: hashmap! {
                    s("AWS_KEY_ID") => s("super secure access key"),
                    s("AWS_SECRET_KEY") => s("even more secure secret key"),
                    s("REGION") => s("us-east-1 aka anti-multi-availability"),
