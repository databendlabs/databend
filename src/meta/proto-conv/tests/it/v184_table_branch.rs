...
#[test]
fn test_decode_v184_table_branch() -> anyhow::Result<()> {
    let table_branch_v184: Vec<u8> = vec![
        10, 23, 50, 48, 50, 51, 45, 49, 50, 45, 49, 53, 32, 48, 49, 58, 50, 54, 58, 48, 57, 32, 85,
        84, 67, 16, 1, 160, 6, 184, 1, 168, 6, 24,
    ];
    ...
    common::test_load_old(func_name!(), table_branch_v184.as_slice(), 184, want())
}

#[test]
fn test_decode_v184_dropped_branch() -> anyhow::Result<()> {
    let table_dropped_branch_v184: Vec<u8> = vec![
        10, 23, 50, 48, 50, 51, 45, 49, 50, 45, 49, 53, 32, 48, 49, 58, 50, 54, 58, 48, 57, 32, 85,
        84, 67, 18, 23, 50, 48, 50, 51, 45, 49, 50, 45, 49, 53, 32, 48, 54, 58, 53, 57, 58, 50, 57,
        32, 85, 84, 67, 160, 6, 184, 1, 168, 6, 24,
    ];
...
#[test]
fn test_decode_v184_table_id_branch_name() -> anyhow::Result<()> {
    let table_id_branch_name_v184: Vec<u8> =
        vec![8, 1, 18, 3, 100, 101, 118, 160, 6, 184, 1, 168, 6, 24];
