...
fn test_load_old() -> anyhow::Result<()> {
    ...
    // TableMeta is loadable
    {
        println!("tbl_meta_v1");
        {
            ...
            // TODO: this message is with VER=2, not 1
            // println!("{:?}", p);
