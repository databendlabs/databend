...
fn test_user_stage_fs_v17() -> anyhow::Result<()> {
    ...
    let user_stage_fs_v17 = vec![
        ...
        160, 6, 17, 168, 6, 1, 34, 31, 8, 1, 16, 128, 8, 26, 1, 124, 34, 2, 47, 47, 40, 2, 50, 3,
        114, 111, 119, 58, 4, 100, 97, 116, 97, 160, 6, 17, 168, 6, 1, 42, 10, 10, 3, 32, 154, 5,
        16, 142, 8, 24, 1, 50, 4, 116, 101, 115, 116, 160, 6, 17, 168, 6, 1,
    ];
