...
// *************************************************************
//
// The user_info_v71 bytes are built from the output of `test_pb_from_to()`
#[test]
fn test_decode_v71_user() -> anyhow::Result<()> {
    let user_info_v71 = vec![
        10, 2, 117, 49, 18, 1, 37, 26, 8, 10, 0, 160, 6, 70, 168, 6, 24, 34, 70, 10, 31, 10, 21,
        58, 13, 10, 7, 100, 101, 102, 97, 117, 108, 116, 16, 1, 24, 10, 160, 6, 70, 168, 6, 24, 16,
        4, 160, 6, 70, 168, 6, 24, 10, 29, 10, 19, 50, 11, 10, 7, 100, 101, 102, 97, 117, 108, 116,
        16, 1, 160, 6, 70, 168, 6, 24, 16, 2, 160, 6, 70, 168, 6, 24, 160, 6, 70, 168, 6, 24, 42,
        6, 160, 6, 70, 168, 6, 24, 50, 6, 160, 6, 70, 168, 6, 24, 58, 32, 18, 24, 10, 20, 164, 182,
        21, 115, 25, 3, 135, 36, 227, 86, 8, 148, 247, 249, 50, 200, 136, 110, 191, 207, 16, 1,
        160, 6, 70, 168, 6, 24, 58, 32, 18, 24, 10, 20, 161, 84, 197, 37, 101, 233, 231, 249, 75,
        252, 8, 161, 254, 112, 38, 36, 237, 142, 255, 218, 16, 1, 160, 6, 70, 168, 6, 24, 66, 23,
        ...
        48, 57, 32, 85, 84, 67, 160, 6, 71, 168, 6, 24,
    ];
