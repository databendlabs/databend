...
fn test_decode_v115_add_udaf_script() -> anyhow::Result<()> {
    let bytes: Vec<u8> = vec![
        ...
        101, 115, 99, 114, 105, 112, 116, 105, 111, 110, 66, 91, 10, 9, 115, 111, 109, 101, 32, 99,
        ...
        115, 168, 6, 24, 160, 6, 115, 168, 6, 24, 50, 3, 115, 117, 109, 58, 17, 154, 2, 8, 66, 0,
        160, 6, 115, 168, 6, 24, 160, 6, 115, 168, 6, 24, 160, 6, 115, 168, 6, 24, 42, 23, 49, 57,
