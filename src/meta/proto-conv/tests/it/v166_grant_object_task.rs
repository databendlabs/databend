...
fn test_decode_v166_grant_object() -> anyhow::Result<()> {
    let role_info_v166 = vec![
        10, 9, 116, 97, 115, 107, 95, 114, 111, 108, 101, 18, 60, 10, 24, 10, 9,
        10, 0, 160, 6, 166, 1, 168, 6, 24, 16, 128, 128, 128, 128, 16, 160, 6,
        166, 1, 168, 6, 24, 10, 25, 10, 13, 114, 4, 10, 2, 116, 49, 160, 6,
        166, 1, 168, 6, 24, 16, 128, 1, 160, 6, 166, 1, 168, 6, 24, 160, 6,
        166, 1, 168, 6, 24, 26, 23, 49, 57, 55, 48, 45, 48, 49, 45, 48, 49,
        32, 48, 48, 58, 48, 48, 58, 48, 48, 32, 85, 84, 67, 34, 23, 49, 57,
        55, 48, 45, 48, 49, 45, 48, 49, 32, 48, 48, 58, 48, 48, 58, 48, 48,
        32, 85, 84, 67, 160, 6, 166, 1, 168, 6, 24,
    ];
...
fn test_decode_v166_task_ownership() -> anyhow::Result<()> {
    let ownership_info_v166 = vec![
        10, 10, 111, 119, 110, 101, 114, 95, 114, 111, 108, 101, 18, 13, 90, 4,
        10, 2, 116, 49, 160, 6, 166, 1, 168, 6, 24, 160, 6, 166, 1, 168, 6,
        24,
    ];
