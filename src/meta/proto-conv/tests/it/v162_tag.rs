...
fn test_decode_v162_tag_meta() -> anyhow::Result<()> {
    let tag_meta_v162 = vec![
        10, 13, 10, 5, 97, 108, 112, 104, 97, 10, 4, 98, 101, 116, 97, 18, 23, 116, 97, 103, 32,
        100, 101, 115, 99, 114, 105, 98, 105, 110, 103, 32, 112, 114, 105, 111, 114, 105, 116, 121,
        26, 23, 50, 48, 50, 52, 45, 49, 50, 45, 49, 50, 32, 48, 55, 58, 51, 48, 58, 48, 48, 32, 85,
        84, 67, 34, 23, 50, 48, 50, 52, 45, 49, 50, 45, 51, 49, 32, 48, 51, 58, 48, 53, 58, 48, 54,
        32, 85, 84, 67, 48, 1, 160, 6, 162, 1, 168, 6, 24,
    ];
    let want = || TagMeta {
