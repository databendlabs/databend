...
fn test_decode_v79_udf_python() -> anyhow::Result<()> {
    let bytes: Vec<u8> = vec![
        ...
        110, 34, 17, 154, 2, 8, 58, 0, 160, 6, 79, 168, 6, 24, 160, 6, 79, 168, 6, 24, 34, 17, 154,
        2, 8, 58, 0, 160, 6, 79, 168, 6, 24, 160, 6, 79, 168, 6, 24, 42, 17, 154, 2, 8, 66, 0, 160,
        6, 79, 168, 6, 24, 160, 6, 79, 168, 6, 24, 160, 6, 79, 168, 6, 24, 42, 23, 50, 48, 50, 51,
        45, 49, 50, 45, 49, 53, 32, 48, 49, 58, 50, 54, 58, 48, 57, 32, 85, 84, 67, 160, 6, 79,
        168, 6, 24,
    ];
...
fn test_decode_v79_udf_sql() -> anyhow::Result<()> {
    let bytes: Vec<u8> = vec![
        ...
        108, 40, 112, 41, 41, 160, 6, 79, 168, 6, 24, 42, 23, 49, 57, 55, 53, 45, 48, 53, 45, 50,
        53, 32, 49, 54, 58, 51, 57, 58, 52, 52, 32, 85, 84, 67, 160, 6, 79, 168, 6, 24,
    ];
