...
use databend_common_meta_app::principal::UDAFServer;
...
fn test_decode_v115_add_udaf_script() -> anyhow::Result<()> {
    let bytes: Vec<u8> = vec![
        ...
        101, 115, 99, 114, 105, 112, 116, 105, 111, 110, 66, 99, 10, 9, 115, 111, 109, 101, 32, 99,
...
#[test]
fn test_decode_v115_add_udaf_server() -> anyhow::Result<()> {
    let bytes: Vec<u8> = vec![
        10, 5, 109, 121, 95, 102, 110, 18, 21, 84, 104, 105, 115, 32, 105, 115, 32, 97, 32, 100,
        101, 115, 99, 114, 105, 112, 116, 105, 111, 110, 58, 102, 10, 12, 115, 111, 109, 101, 32,
        97, 100, 100, 114, 101, 115, 115, 18, 10, 106, 97, 118, 97, 115, 99, 114, 105, 112, 116,
        26, 17, 154, 2, 8, 74, 0, 160, 6, 115, 168, 6, 24, 160, 6, 115, 168, 6, 24, 34, 17, 154, 2,
        8, 58, 0, 160, 6, 115, 168, 6, 24, 160, 6, 115, 168, 6, 24, 42, 30, 10, 3, 115, 117, 109,
        26, 17, 154, 2, 8, 66, 0, 160, 6, 115, 168, 6, 24, 160, 6, 115, 168, 6, 24, 160, 6, 115,
        168, 6, 24, 160, 6, 115, 168, 6, 24, 42, 23, 49, 57, 55, 48, 45, 48, 49, 45, 48, 49, 32,
        48, 48, 58, 48, 48, 58, 48, 48, 32, 85, 84, 67, 160, 6, 115, 168, 6, 24,
    ];

    let want = || UserDefinedFunction {
        name: "my_fn".to_string(),
        description: "This is a description".to_string(),
        definition: UDFDefinition::UDAFServer(UDAFServer {
