...
#[test]
fn test_decode_v96_database_meta() -> anyhow::Result<()> {
    let bytes: Vec<u8> = vec![
        ...
        96, 168, 6, 24, 210, 1, 8, 101, 110, 100, 112, 111, 105, 110, 116, 160, 6, 96, 168, 6, 24,
    ];
    ...
    common::test_load_old(func_name!(), bytes.as_slice(), 96, want())
}
