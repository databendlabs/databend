...
use crate::sm_v002::SnapshotStoreV003;
...
pub struct LineConvertV002ToV003 {
    pub sys_data: Arc<Mutex<SysData>>,
}

impl LineConvertV002ToV003 {
...
impl ordq::Work for LineConvertV002ToV003 {
...
pub async fn upgrade_snapshot_data_v002_to_v003(
    ...
    let (ordq_tx, ordq_rx) = {
        ...
        ordq::new(
            queue_depth,
            repeat_with(|| LineConvertV002ToV003 {
