...
pub mod row;
pub use lex_sort::build_compare;
pub use lex_sort::lexsort;
pub use lex_sort::lexsort_to_indices;
pub use lex_sort::lexsort_to_indices_impl;
pub use lex_sort::SortColumn;
...
/// Compare two `Array`s based on the ordering defined in [ord](crate::arrow::array::ord).
