...
/// use arrow2::compute::sort::lexsort;
...
/// let utf8 = Utf8Array::<i32>::from(&vec![
///     Some("hello"),
///     Some("world"),
///     Some(","),
///     Some("foobar"),
...
pub fn build_compare(array: &dyn Array, sort_option: SortOptions) -> Result<DynComparator> {
