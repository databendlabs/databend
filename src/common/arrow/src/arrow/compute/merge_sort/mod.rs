...
use crate::arrow::array::ord::build_compare;
...
/// * the arrays do not have the same [`crate::arrow::datatypes::DataType`] (as it makes no sense to take together from them)
...
/// Combines two sorted [Array]s of the same [`crate::arrow::datatypes::DataType`] into a single sorted array.
/// If the arrays are not sorted (which this function does not check), the result is wrong.
/// # Error
/// This function errors when:
/// * the arrays have a different [`crate::arrow::datatypes::DataType`]
/// * the arrays have a [`crate::arrow::datatypes::DataType`] that has no order relationship
/// # Example
/// ```rust
...
/// they have not the same [`crate::arrow::datatypes::DataType`] or when their [`crate::arrow::datatypes::DataType`]
