...
use super::primitive_as_primitive;
use super::primitive_to_primitive;
use super::CastOptions;
use crate::arrow::array::Array;
use crate::arrow::array::DictionaryArray;
use crate::arrow::array::DictionaryKey;
use crate::arrow::array::PrimitiveArray;
use crate::arrow::compute::cast::cast;
use crate::arrow::compute::take::take;
...
pub fn wrapping_dictionary_to_dictionary_values<K: DictionaryKey>(
    ...
    let values = cast(values.as_ref(), values_type, CastOptions {
        wrapped: true,
        partial: false,
    })?;
    assert_eq!(values.len(), length); // this is guaranteed by `cast`
...
where K: DictionaryKey + num_traits::NumCast {
