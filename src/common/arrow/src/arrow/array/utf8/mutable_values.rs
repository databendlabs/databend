...
impl<O: Offset> MutableUtf8ValuesArray<O> {
    ...
    /// * The `data_type`'s [`crate::arrow::datatypes::PhysicalType`] is not equal to either `Utf8` or `LargeUtf8`.
    ...
    /// * The `data_type`'s [`crate::arrow::datatypes::PhysicalType`] is equal to either `Utf8` or `LargeUtf8`.
    /// # Safety
