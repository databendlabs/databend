...
#[cfg(feature = "arrow")]
pub(crate) fn to_buffer<T: crate::arrow::types::NativeType>(
...
#[cfg(feature = "arrow")]
pub(crate) fn to_bytes<T: crate::arrow::types::NativeType>(
    ...
    let owner = crate::arrow::buffer::BytesAllocator::Arrow(value);
