...
use arrow_format::ipc::FieldRef;
use arrow_format::ipc::FixedSizeListRef;
use arrow_format::ipc::MapRef;
use arrow_format::ipc::TimeRef;
use arrow_format::ipc::TimestampRef;
use arrow_format::ipc::UnionRef;

use super::super::IpcField;
use super::super::IpcSchema;
use super::OutOfSpecKind;
use super::StreamMetadata;
use crate::arrow::datatypes::get_extension;
use crate::arrow::datatypes::DataType;
use crate::arrow::datatypes::Extension;
...
fn deserialize_list(field: FieldRef) -> Result<(DataType, IpcField)> {
    ...
    Ok((DataType::List(Box::new(field)), IpcField {
        fields: vec![ipc_field],
        dictionary_id: None,
    }))
}
...
fn deserialize_large_list(field: FieldRef) -> Result<(DataType, IpcField)> {
    ...
    Ok((DataType::LargeList(Box::new(field)), IpcField {
        fields: vec![ipc_field],
        dictionary_id: None,
    }))
}
...
fn deserialize_fixed_size_list(
    ...
    Ok((DataType::FixedSizeList(Box::new(field), size), IpcField {
        fields: vec![ipc_field],
        dictionary_id: None,
    }))
}
...
pub(super) fn fb_to_schema(schema: arrow_format::ipc::SchemaRef) -> Result<(Schema, IpcSchema)> {
    ...
    Ok((Schema { fields, metadata }, IpcSchema {
        fields: ipc_fields,
        is_little_endian,
    }))
}
