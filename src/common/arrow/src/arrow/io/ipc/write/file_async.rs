...
use arrow_format::ipc::Block;
use arrow_format::ipc::Footer;
...
use crate::arrow::io::ipc::ARROW_MAGIC_V2;
...
/// use arrow2::io::ipc::read::file_async::read_file_metadata_async;
/// use arrow2::io::ipc::read::file_async::FileStream;
