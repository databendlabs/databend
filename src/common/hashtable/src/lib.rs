...
pub type PartitionedHashMap<Inner, const BUCKETS_LG2: u32> = partitioned_hashtable::PartitionedHashtable<Inner, BUCKETS_LG2>;
pub type PartitionedHashSet<K, const BUCKETS_LG2: u32> = partitioned_hashtable::PartitionedHashtable<HashSet<K>, BUCKETS_LG2>;
