...
use crate::encoding::hybrid_rle::{self};
...
where I: Iterator<Item = Result<hybrid_rle::HybridEncoded<'a>, Error>>
{
    iter: I,
    length: usize,
    consumed: usize,
...
where I: Iterator<Item = Result<HybridEncoded<'a>, Error>>
{
    iter: I,
...
where I: HybridRleRunsIterator<'a>
{
