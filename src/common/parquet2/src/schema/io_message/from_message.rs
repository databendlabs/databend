...
use super::super::types::TimeUnit;
use super::super::*;
use crate::error::Error;
use crate::error::Result;
use crate::schema::types::GroupConvertedType;
use crate::schema::types::PrimitiveConvertedType;
...
mod tests {
    ...
    ";
        ...
        assert_eq!(res, vec![
            ...
            "optional", "binary", "c", "(", "UTF8", ")", ";", "}", "required", "group", "e", "(",
            "LIST", ")", "{", "repeated", "group", "list", "{", "required", "int32", "element",
            ";", "}", "}", "}"
        ]);
    }
