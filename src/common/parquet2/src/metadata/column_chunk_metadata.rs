...
use parquet_format_safe::ColumnMetaData;
use parquet_format_safe::Encoding;
...
use crate::statistics::deserialize_statistics;
...
mod serde_types {
    ...
    pub use parquet_format_safe::thrift::protocol::TCompactInputProtocol;
    pub use parquet_format_safe::thrift::protocol::TCompactOutputProtocol;
