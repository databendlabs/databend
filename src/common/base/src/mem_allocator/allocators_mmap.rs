...
pub struct MmapAllocator<const CLEAR_MEM: bool, const MMAP_POPULATE: bool, Allocator: GlobalAlloc> {
    allocator: Allocator,
}

impl<const CLEAR_MEM: bool, const MMAP_POPULATE: bool, Allocator: GlobalAlloc + Default>
    MmapAllocator<CLEAR_MEM, MMAP_POPULATE, Allocator>
{
...
impl<const CLEAR_MEM: bool, const MMAP_POPULATE: bool, Allocator: GlobalAlloc>
    MmapAllocator<CLEAR_MEM, MMAP_POPULATE, Allocator>
{
    #[inline]
...
unsafe impl<const CLEAR_MEM: bool, const MMAP_POPULATE: bool, Allocator: GlobalAlloc> GlobalAlloc
    for MmapAllocator<CLEAR_MEM, MMAP_POPULATE, Allocator>
{
    /// # Panics
    ///
    ...
    unsafe fn realloc(&self, ptr: *mut u8, layout: Layout, new_size: usize) -> *mut u8 {
            ...
            && layout.align() <= MALLOC_MIN_ALIGNMENT
        {
            ...
            let new_buf =
                self.alloc_inner(Layout::from_size_align_unchecked(new_size, layout.align()));
...
mod tests {
    ...
    type ALOC = MmapAllocator<false, true, Allocator>;
