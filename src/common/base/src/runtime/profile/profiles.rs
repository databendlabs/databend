    ...
    PROFILES_DESC.get_or_init(|| {
        Arc::new(BTreeMap::from([
            ...
            (ProfileStatisticsName::ScanBytes, ProfileDesc {
                display_name: "bytes scanned (uncompressed)",
                desc: "The bytes scanned of query (uncompressed)",
            ...
            (ProfileStatisticsName::ScanBytesFromRemote, ProfileDesc {
                display_name: "bytes scanned from remote (compressed)",
            ...
            (ProfileStatisticsName::ScanBytesFromLocal, ProfileDesc {
                display_name: "bytes scanned from local cache (compressed)",
            ...
            (ProfileStatisticsName::ScanBytesFromMemory, ProfileDesc {
                display_name: "bytes scanned from memory cache (compressed)",
