...
* Make sure you have a Kubernetes cluster up and running. For example:
...
It is **higly recommended** to deploy an at least 3-nodes cluster with persistent storage on each node for high availability.
