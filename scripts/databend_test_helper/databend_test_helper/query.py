...
class DatabendQuery:
    ...
    def __init__(self, binary_path: Optional[str] = None, config_path: Optional[str] = None, 
                 profile: Optional[str] = None, args: Optional[QueryArgs] = None,  node_id: Optional[str] = None):
    ...
    def _print_start_info(self) -> None:
        ...
        ProgressReporter.print_message(f"   Cluster: tenant={tenant_id}, cluster={cluster_id}")
