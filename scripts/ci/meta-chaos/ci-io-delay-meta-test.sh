...
python3 tests/metaverifier/chaos-meta.py --mode=io/delay/delay=200ms,percent=5 --namespace=databend --nodes=${HTTP_ADDR} --total=800 --apply_second=5 --recover_second=10