...
python3 tests/metaverifier/chaos-meta.py --mode=io/delay/delay=20ms,percent=5 --namespace=databend --nodes=${HTTP_ADDR} --total=800 --apply_second=2 --recover_second=10
