...
python3 tests/metaverifier/chaos-meta.py --mode=io/delay/delay=2ms,percent=1 --namespace=databend --nodes=${HTTP_ADDR} --total=800 --apply_second=1 --recover_second=10
