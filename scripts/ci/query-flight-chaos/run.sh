...
readonly NAMESPACE="databend-flight-chaos"
readonly IMAGE="databend-query-flight-chaos:ci"
readonly BUILD_PROFILE="${BUILD_PROFILE:-debug}"
readonly CLUSTER_NAME="databend-flight-chaos-${GITHUB_RUN_ID:-local}-${GITHUB_RUN_ATTEMPT:-1}"
...
python "${REPO_DIR}/tests/query-flight-chaos/test_flight_chaos.py" \
	--namespace "${NAMESPACE}" \
